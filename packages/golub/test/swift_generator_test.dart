...
void main() {
  test('gen one class', () {
    ...
    expect(
      code,
      contains('static func fromList(_ golubVar_list: [Any?]) -> Foobar?'),
    );
  ...
  test('gen nested', () {
    ...
    expect(
      code,
      contains('static func fromList(_ golubVar_list: [Any?]) -> Outer?'),
    );
    expect(
      code,
      contains('let nested: Nested? = nilOrValue(golubVar_list[0])'),
    );
    expect(code, contains('func toList() -> [Any?]'));
    expect(code, isNot(contains('if (')));
  ...
  test('generic class with single type parameter', () {
    ...
    expect(
      code,
      contains('static func fromList(_ golubVar_list: [Any?]) -> Wrapper?'),
    );
  ...
  test('generic class with multiple type parameters', () {
    ...
    expect(
      code,
      contains('static func fromList(_ golubVar_list: [Any?]) -> Pair?'),
    );
  ...
  test('generic class with nested generic field types', () {
    ...
    expect(
      code,
      contains('static func fromList(_ golubVar_list: [Any?]) -> Container?'),
    );
  ...
  test('generic class with generic superclass', () {
    ...
    expect(
      code,
      contains(
        'static func fromList(_ golubVar_list: [Any?]) -> SpecialList?',
      ),
    );
  });
  ...
  test('generic class serialization methods', () {
    ...
    expect(
      code,
      contains('static func fromList(_ golubVar_list: [Any?]) -> Result?'),
    );
  ...
  test('generic class with Hashable constraints for Map keys', () {
    ...
    expect(
      code,
      contains(
        'static func fromList(_ golubVar_list: [Any?]) -> KeyValueStore?',
      ),
    );
