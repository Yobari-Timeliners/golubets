...
/// The current version of golub.
///
/// This must match the version in pubspec.yaml.
const String golubVersion = '1.0.0';
...
String makeChannelNameWithStrings({
  ...
  return 'dev.bayori.golub.$dartPackageName.$apiName.$methodName';
}
...
/// used internally, to avoid churn in Golub test files.
...
const String generatedCodeWarning =
    'Autogenerated from Golub (v$golubVersion), do not edit directly.';

/// Warning printed at the top of all generated code.
String getGeneratedCodeWarning() {
  final String versionString =
      includeVersionInGeneratedWarning ? ' (v$golubVersion)' : '';
  return 'Autogenerated from Golub$versionString, do not edit directly.';
}

/// String to be printed after `getGeneratedCodeWarning()'s warning`.
const String seeAlsoWarning = 'See also: https://pub.dev/packages/golub';

/// Prefix for generated internal classes.
///
/// This lowers the chances of variable name collisions with user defined
/// parameters.
const String classNamePrefix = 'GolubInternal';

/// Prefix for utility classes generated to be used with ProxyAPIs.
///
/// This lowers the chances of variable name collisions with user defined
/// parameters.
const String proxyApiClassNamePrefix = 'Golub';
...
/// This lowers the chances of variable name collisions with user defined
/// parameters.
const String classMemberNamePrefix = 'golub_';

/// Prefix for variable names not defined by the user.
///
/// This lowers the chances of variable name collisions with user defined
/// parameters.
const String varNamePrefix = 'golubVar_';
...
Iterable<NamedType> getFieldsInSerializationOrder(Class classDefinition) {
  // This returns the fields in the order they are declared in the golub file.
