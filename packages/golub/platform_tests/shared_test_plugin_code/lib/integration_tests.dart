...
void runPigeonIntegrationTests(TargetGenerator targetGenerator) {
  ...
  group('Host sync API tests', () {
    ...
    testWidgets('all nullable datatypes serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypes? echoObject = await api.echoAllNullableTypes(recursiveAllNullableTypes);
    ...
    testWidgets('Classes with list of null serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypes listTypes = AllNullableTypes(list: <String?>['String', null]);
    ...
    testWidgets('Classes with map of null serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypes listTypes = AllNullableTypes(map: <String?, String?>{'String': 'string', 'null': null});
    ...
    testWidgets('all nullable datatypes without recursion serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypesWithoutRecursion? echoObject =
          await api.echoAllNullableTypesWithoutRecursion(genericAllNullableTypesWithoutRecursion);

      expect(echoObject, genericAllNullableTypesWithoutRecursion);
    });

    testWidgets('all null datatypes without recursion serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypesWithoutRecursion allTypesNull = AllNullableTypesWithoutRecursion();
    ...
    testWidgets('Classes without recursion with list of null serialize and deserialize correctly',
      ...
      final AllNullableTypesWithoutRecursion listTypes = AllNullableTypesWithoutRecursion(
    ...
    testWidgets('flutter errors are returned correctly', (WidgetTester _) async {
      ...
      expect(
          ...
          throwsA((dynamic e) =>
              e is PlatformException && e.code == 'code' && e.message == 'message' && e.details == 'details'));
    });
    ...
    testWidgets('nested null classes can serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final AllClassesWrapper classWrapper = classWrapperMaker();
    ...
    testWidgets('Arguments of multiple types serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      ...
      final AllNullableTypes echoObject =
          await api.sendMultipleNullableTypes(aNullableBool, aNullableInt, aNullableString);
    ...
    testWidgets('Arguments of multiple null types serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypes echoNullFilledClass = await api.sendMultipleNullableTypes(null, null, null);
    ...
    testWidgets('Arguments of multiple types serialize and deserialize correctly (WithoutRecursion)',
        (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      const String aNullableString = 'this is a String';
      const bool aNullableBool = false;
      ...
      final AllNullableTypesWithoutRecursion echoObject =
          await api.sendMultipleNullableTypesWithoutRecursion(aNullableBool, aNullableInt, aNullableString);
      expect(echoObject.aNullableInt, aNullableInt);
      expect(echoObject.aNullableBool, aNullableBool);
      expect(echoObject.aNullableString, aNullableString);
    });

    testWidgets('Arguments of multiple null types serialize and deserialize correctly (WithoutRecursion)',
        (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('Uint8List serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final List<int> data = <int>[102, 111, 114, 116, 121, 45, 116, 119, 111, 0];
    ...
    testWidgets('NonNull class lists serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final List<AllNullableTypes> echoObject = await api.echoNonNullClassList(nonNullAllNullableTypesList);
      for (final (int index, AllNullableTypes value) in echoObject.indexed) {
    ...
    testWidgets('NonNull class maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int, AllNullableTypes> echoObject = await api.echoNonNullClassMap(nonNullAllNullableTypesMap);
      for (final MapEntry<int, AllNullableTypes> entry in echoObject.entries) {
    ...
    testWidgets('generic nullable Objects serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      const Object sentString = "I'm a computer";
    ...
    testWidgets('nullable lists serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final List<AllNullableTypes?>? echoObject = await api.echoNullableClassList(allNullableTypesList);
      for (final (int index, AllNullableTypes? value) in echoObject!.indexed) {
        expect(value, allNullableTypesList[index]);
      }
    });

    testWidgets('nullable NonNull enum lists serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('nullable NonNull lists serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final List<AllNullableTypes?>? echoObject = await api.echoNullableClassList(nonNullAllNullableTypesList);
      for (final (int index, AllNullableTypes? value) in echoObject!.indexed) {
        expect(value, nonNullAllNullableTypesList[index]);
      }
    });
    ...
    testWidgets('nullable class maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int?, AllNullableTypes?>? echoObject = await api.echoNullableClassMap(allNullableTypesMap);
      for (final MapEntry<int?, AllNullableTypes?> entry in echoObject!.entries) {
        expect(entry.value, allNullableTypesMap[entry.key]);
      }
    });

    testWidgets('nullable NonNull string maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<String?, String?>? echoObject = await api.echoNullableNonNullStringMap(nonNullStringMap);
      expect(mapEquals(echoObject, nonNullStringMap), true);
    });

    testWidgets('nullable NonNull int maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int?, int?>? echoObject = await api.echoNullableNonNullIntMap(nonNullIntMap);
      expect(mapEquals(echoObject, nonNullIntMap), true);
    });

    testWidgets('nullable NonNull enum maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<AnEnum?, AnEnum?>? echoObject = await api.echoNullableNonNullEnumMap(nonNullEnumMap);
      expect(mapEquals(echoObject, nonNullEnumMap), true);
    });

    testWidgets('nullable NonNull class maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('nullable enums serialize and deserialize correctly (again)', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('multi word nullable enums serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
  ...
  group('Host async API tests', () {
    ...
    testWidgets('async errors are returned from non void methods correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('async flutter errors are returned from non void methods correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('all nullable async datatypes serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypes? echoObject = await api.echoAsyncNullableAllNullableTypes(recursiveAllNullableTypes);

      expect(echoObject, recursiveAllNullableTypes);
    });

    testWidgets('all nullable async datatypes serialize and deserialize correctly using `await`-style',
        (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypes? echoObject = await api.echoModernAsyncNullableAllNullableTypes(recursiveAllNullableTypes);

      expect(echoObject, recursiveAllNullableTypes);
    });

    testWidgets('all datatypes async serialize and deserialize correctly using `await`-style', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('all datatypes async serialize and deserialize correctly using `await`-style and does not throw',
        (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('all datatypes async serialize correctly using `await`-style and throws', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('all null datatypes async serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypes allTypesNull = AllNullableTypes();

      final AllNullableTypes? echoNullFilledClass = await api.echoAsyncNullableAllNullableTypes(allTypesNull);
      expect(echoNullFilledClass, allTypesNull);
    });

    testWidgets('all null datatypes async serialize and deserialize correctly using `await`-style',
        (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypes allTypesNull = AllNullableTypes();

      final AllNullableTypes? echoNullFilledClass = await api.echoModernAsyncNullableAllNullableTypes(allTypesNull);
      expect(echoNullFilledClass, allTypesNull);
    });

    testWidgets('all nullable async datatypes without recursion serialize and deserialize correctly',
        (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final AllNullableTypesWithoutRecursion? echoObject =
          await api.echoAsyncNullableAllNullableTypesWithoutRecursion(genericAllNullableTypesWithoutRecursion);
    ...
    testWidgets('all null datatypes without recursion async serialize and deserialize correctly',
      ...
      final AllNullableTypesWithoutRecursion? echoNullFilledClass =
          await api.echoAsyncNullableAllNullableTypesWithoutRecursion(allTypesNull);
      expect(echoNullFilledClass, allTypesNull);
    });
    ...
    testWidgets('generic Objects async serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      const Object sentString = "I'm a computer";
    ...
    testWidgets('class maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int?, AllNullableTypes?> echoObject = await api.echoAsyncClassMap(allNullableTypesMap);
      for (final MapEntry<int?, AllNullableTypes?> entry in echoObject.entries) {
        expect(entry.value, allNullableTypesMap[entry.key]);
      }
    });
    ...
    testWidgets('nullable Doubles async serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('nullable booleans async serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('nullable strings async serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
    ...
    testWidgets('nullable Uint8List async serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final List<int> data = <int>[102, 111, 114, 116, 121, 45, 116, 119, 111, 0];
      final Uint8List sentUint8List = Uint8List.fromList(data);
    ...
    testWidgets('nullable generic Objects async serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      const Object sentString = "I'm a computer";
    ...
    testWidgets('nullable class lists serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final List<AllNullableTypes?>? echoObject = await api.echoAsyncNullableClassList(allNullableTypesList);
      for (final (int index, AllNullableTypes? value) in echoObject!.indexed) {
        expect(value, allNullableTypesList[index]);
      }
    });
    ...
    testWidgets('nullable class maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int?, AllNullableTypes?>? echoObject = await api.echoAsyncNullableClassMap(allNullableTypesMap);
      for (final MapEntry<int?, AllNullableTypes?> entry in echoObject!.entries) {
        expect(entry.value, allNullableTypesMap[entry.key]);
      }
    });
    ...
    testWidgets('null generic Objects async serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
  ...
  group('Host API with suffix', () {
    testWidgets('echo string succeeds with suffix with multiple instances', (_) async {
      final HostSmallApi apiWithSuffixOne = HostSmallApi(messageChannelSuffix: 'suffixOne');
      final HostSmallApi apiWithSuffixTwo = HostSmallApi(messageChannelSuffix: 'suffixTwo');
      const String sentString = "I'm a computer";
    ...
    testWidgets('multiple instances will have different method channel names', (_) async {
      ...
      final HostSmallApi apiWithSuffixOne = HostSmallApi(messageChannelSuffix: 'suffixWithNoHost');
      final HostSmallApi apiWithSuffixTwo = HostSmallApi(messageChannelSuffix: 'suffixWithoutHost');
      const String sentString = "I'm a computer";
      try {
  ...
  group('Flutter API tests', () {
    ...
    testWidgets('Arguments of multiple types serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final AllNullableTypes compositeObject =
          await api.callFlutterSendMultipleNullableTypes(aNullableBool, aNullableInt, aNullableString);
    ...
    testWidgets('Arguments of multiple null types serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final AllNullableTypes compositeObject = await api.callFlutterSendMultipleNullableTypes(null, null, null);
    ...
    testWidgets('Arguments of multiple types serialize and deserialize correctly (WithoutRecursion)',
      ...
      final AllNullableTypesWithoutRecursion compositeObject =
          await api.callFlutterSendMultipleNullableTypesWithoutRecursion(aNullableBool, aNullableInt, aNullableString);
      expect(compositeObject.aNullableInt, aNullableInt);
      expect(compositeObject.aNullableBool, aNullableBool);
      expect(compositeObject.aNullableString, aNullableString);
    });
    ...
    testWidgets('Arguments of multiple null types serialize and deserialize correctly (WithoutRecursion)',
      ...
      final AllNullableTypesWithoutRecursion compositeObject =
          await api.callFlutterSendMultipleNullableTypesWithoutRecursion(null, null, null);
      expect(compositeObject.aNullableInt, null);
      expect(compositeObject.aNullableBool, null);
      expect(compositeObject.aNullableString, null);
    });
    ...
    testWidgets('class lists serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final List<AllNullableTypes?> echoObject = await api.callFlutterEchoClassList(allNullableTypesList);
      for (final (int index, AllNullableTypes? value) in echoObject.indexed) {
        expect(value, allNullableTypesList[index]);
      }
    });
    ...
    testWidgets('NonNull class lists serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final List<AllNullableTypes> echoObject = await api.callFlutterEchoNonNullClassList(nonNullAllNullableTypesList);
      for (final (int index, AllNullableTypes? value) in echoObject.indexed) {
        expect(value, nonNullAllNullableTypesList[index]);
      }
    });
    ...
    testWidgets('class maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int?, AllNullableTypes?> echoObject = await api.callFlutterEchoClassMap(allNullableTypesMap);
      for (final MapEntry<int?, AllNullableTypes?> entry in echoObject.entries) {
        expect(entry.value, allNullableTypesMap[entry.key]);
      }
    });
    ...
    testWidgets('NonNull string maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<String, String> echoObject = await api.callFlutterEchoNonNullStringMap(nonNullStringMap);
      expect(mapEquals(echoObject, nonNullStringMap), true);
    });
    ...
    testWidgets('NonNull enum maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<AnEnum, AnEnum> echoObject = await api.callFlutterEchoNonNullEnumMap(nonNullEnumMap);
      expect(mapEquals(echoObject, nonNullEnumMap), true);
    });
    ...
    testWidgets('nullable class lists serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final List<AllNullableTypes?>? echoObject = await api.callFlutterEchoNullableClassList(allNullableTypesList);
      for (final (int index, AllNullableTypes? value) in echoObject!.indexed) {
        expect(value, allNullableTypesList[index]);
      }
    });
    ...
    testWidgets('nullable NonNull enum lists serialize and deserialize correctly', (WidgetTester _) async {
      ...
      final List<AnEnum?>? echoObject = await api.callFlutterEchoNullableNonNullEnumList(nonNullEnumList);
      expect(listEquals(echoObject, nonNullEnumList), true);
    });

    testWidgets('nullable NonNull class lists serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();

      final List<AllNullableTypes?>? echoObject =
          await api.callFlutterEchoNullableNonNullClassList(nonNullAllNullableTypesList);
      for (final (int index, AllNullableTypes? value) in echoObject!.indexed) {
        expect(value, nonNullAllNullableTypesList[index]);
      }
    });
    ...
    testWidgets('nullable string maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<String?, String?>? echoObject = await api.callFlutterEchoNullableStringMap(stringMap);
      expect(mapEquals(echoObject, stringMap), true);
    });
    ...
    testWidgets('nullable class maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int?, AllNullableTypes?>? echoObject = await api.callFlutterEchoNullableClassMap(allNullableTypesMap);
      for (final MapEntry<int?, AllNullableTypes?> entry in echoObject!.entries) {
        expect(entry.value, allNullableTypesMap[entry.key]);
      }
    });
    ...
    testWidgets('nullable NonNull string maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<String?, String?>? echoObject = await api.callFlutterEchoNullableNonNullStringMap(nonNullStringMap);
      expect(mapEquals(echoObject, nonNullStringMap), true);
    });

    testWidgets('nullable NonNull int maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int?, int?>? echoObject = await api.callFlutterEchoNullableNonNullIntMap(nonNullIntMap);
      expect(mapEquals(echoObject, nonNullIntMap), true);
    });

    testWidgets('nullable NonNull enum maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<AnEnum?, AnEnum?>? echoObject = await api.callFlutterEchoNullableNonNullEnumMap(nonNullEnumMap);
      expect(mapEquals(echoObject, nonNullEnumMap), true);
    });
    ...
    testWidgets('nullable NonNull class maps serialize and deserialize correctly', (WidgetTester _) async {
      final HostIntegrationCoreApi api = HostIntegrationCoreApi();
      final Map<int?, AllNullableTypes?>? echoObject =
          await api.callFlutterEchoNullableNonNullClassMap(nonNullAllNullableTypesMap);
      for (final MapEntry<int?, AllNullableTypes?> entry in echoObject!.entries) {
        expect(entry.value, nonNullAllNullableTypesMap[entry.key]);
      }
    });
  ...
  group('Proxy API Tests', () {
    ...
    testWidgets('throwFlutterError', (_) async {
      ...
      await expectLater(
        ...
        throwsA(
          (dynamic e) {
            return e is PlatformException && e.code == 'code' && e.message == 'message' && e.details == 'details';
          },
        ),
      );
    });
  ...
  const List<TargetGenerator> eventChannelSupported = <TargetGenerator>[TargetGenerator.kotlin, TargetGenerator.swift];
  ...
  testWidgets(
    ...
    (WidgetTester _) async {
      ...
      const int sentInt = regularInt;
      final PlatformEvent receivedEvent = await api.echo(IntEvent(value: sentInt));
  ...
  testWidgets(
    ...
    (WidgetTester _) async {
      ...
      const double sentDouble = 2.0694;
      final PlatformEvent receivedEvent = await api.echo(DoubleEvent(value: sentDouble));
      switch (receivedEvent) {
        case DoubleEvent():
  ...
  testWidgets(
    ...
    (WidgetTester _) async {
      ...
      for (final bool sentBool in <bool>[true, false]) {
        final PlatformEvent receivedEvent = await api.echo(BoolEvent(value: sentBool));
        switch (receivedEvent) {
          case BoolEvent():
  ...
  testWidgets(
    ...
    (WidgetTester _) async {
      ...
      const String sentString = 'default';
      final PlatformEvent receivedEvent = await api.echo(StringEvent(value: sentString));
      switch (receivedEvent) {
        case StringEvent():
  ...
  testWidgets(
    ...
    (WidgetTester _) async {
      ...
      final PlatformEvent receivedEvent = await api.echo(ObjectsEvent(value: sentObject));
      switch (receivedEvent) {
        case ObjectsEvent():
  ...
  testWidgets(
    ...
    (WidgetTester _) async {
      ...
      final PlatformEvent receivedEvent = await api.echo(EnumEvent(value: sentEnum));
      switch (receivedEvent) {
        case EnumEvent():
  ...
  testWidgets(
    ...
    (WidgetTester _) async {
      final SealedClassApi api = SealedClassApi();
      final EventAllNullableTypes sentEventAllNullableTypes = genericEventAllNullableTypesWithoutRecursion;
