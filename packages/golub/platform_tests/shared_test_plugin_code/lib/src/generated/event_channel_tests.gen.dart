...
Stream<int> streamInts({String instanceName = ''}) {
  ...
  final EventChannel streamIntsChannel = EventChannel(
    'dev.bayori.golub.golub_integration_tests.EventChannelMethods.streamInts$instanceName',
    golubMethodCodec,
  );
...
Stream<PlatformEvent> streamEvents({String instanceName = ''}) {
  ...
  final EventChannel streamEventsChannel = EventChannel(
    'dev.bayori.golub.golub_integration_tests.EventChannelMethods.streamEvents$instanceName',
    golubMethodCodec,
  );
...
Stream<int> streamConsistentNumbers({String instanceName = ''}) {
  ...
  final EventChannel streamConsistentNumbersChannel = EventChannel(
    'dev.bayori.golub.golub_integration_tests.EventChannelMethods.streamConsistentNumbers$instanceName',
    golubMethodCodec,
  );
...
class SealedClassApi {
  ...
  Future<PlatformEvent> echo(PlatformEvent event) async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_integration_tests.SealedClassApi.echo$golubVar_messageChannelSuffix';
    ...
    if (golubVar_replyList == null) {
      ...
      return (golubVar_replyList[0] as PlatformEvent?)!;
    }
  }
}
