...
class NullFieldsHostApi {
  ...
  Future<NullFieldsSearchReply> search(NullFieldsSearchRequest nested) async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_integration_tests.NullFieldsHostApi.search$golubVar_messageChannelSuffix';
    ...
    if (golubVar_replyList == null) {
      ...
      return (golubVar_replyList[0] as NullFieldsSearchReply?)!;
    }
  }
}
  ...
  static void setUp(
        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      golubVar_channel = BasicMessageChannel<Object?>(
        'dev.bayori.golub.golub_integration_tests.NullFieldsFlutterApi.search$messageChannelSuffix',
        golubChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
        ...
        golubVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.bayori.golub.golub_integration_tests.NullFieldsFlutterApi.search was null.',
          );
          ...
          assert(
            arg_request != null,
            'Argument for dev.bayori.golub.golub_integration_tests.NullFieldsFlutterApi.search was null, expected non-null NullFieldsSearchRequest.',
          );
          try {
