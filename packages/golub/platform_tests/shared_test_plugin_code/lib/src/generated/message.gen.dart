...
class MessageApi {
  ...
  Future<void> initialize() async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_integration_tests.MessageApi.initialize$golubVar_messageChannelSuffix';
  ...
  Future<MessageSearchReply> search(MessageSearchRequest request) async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_integration_tests.MessageApi.search$golubVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> golubVar_channel =
        BasicMessageChannel<Object?>(
          golubVar_channelName,
          golubChannelCodec,
    ...
    if (golubVar_replyList == null) {
      ...
      return (golubVar_replyList[0] as MessageSearchReply?)!;
    }
  }
}
...
class MessageNestedApi {
  ...
  Future<MessageSearchReply> search(MessageNested nested) async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_integration_tests.MessageNestedApi.search$golubVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> golubVar_channel =
        BasicMessageChannel<Object?>(
          golubVar_channelName,
          golubChannelCodec,
  ...
  static void setUp(
        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      golubVar_channel = BasicMessageChannel<Object?>(
        'dev.bayori.golub.golub_integration_tests.MessageFlutterSearchApi.search$messageChannelSuffix',
        golubChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
        ...
        golubVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.bayori.golub.golub_integration_tests.MessageFlutterSearchApi.search was null.',
          );
          ...
          assert(
            arg_request != null,
            'Argument for dev.bayori.golub.golub_integration_tests.MessageFlutterSearchApi.search was null, expected non-null MessageSearchRequest.',
          );
          try {
