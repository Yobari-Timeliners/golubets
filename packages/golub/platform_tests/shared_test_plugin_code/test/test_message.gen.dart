  ...
  static void setUp(
        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      golubVar_channel = BasicMessageChannel<Object?>(
        'dev.bayori.golub.golub_integration_tests.MessageApi.initialize$messageChannelSuffix',
        golubChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(golubVar_channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(golubVar_channel, (
              Object? message,
            ) async {
              try {
                api.initialize();
    ...
    }
    {
      final BasicMessageChannel<Object?>
      golubVar_channel = BasicMessageChannel<Object?>(
        'dev.bayori.golub.golub_integration_tests.MessageApi.search$messageChannelSuffix',
        golubChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(golubVar_channel, (
              ...
              assert(
                message != null,
                'Argument for dev.bayori.golub.golub_integration_tests.MessageApi.search was null.',
              );
...
abstract class TestNestedApi {
  ...
  static void setUp(
        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      final BasicMessageChannel<Object?>
      golubVar_channel = BasicMessageChannel<Object?>(
        'dev.bayori.golub.golub_integration_tests.MessageNestedApi.search$messageChannelSuffix',
        golubChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(golubVar_channel, (
              ...
              assert(
                message != null,
                'Argument for dev.bayori.golub.golub_integration_tests.MessageNestedApi.search was null.',
              );
              final List<Object?> args = (message as List<Object?>?)!;
              final MessageNested? arg_nested = (args[0] as MessageNested?);
              assert(
                arg_nested != null,
                'Argument for dev.bayori.golub.golub_integration_tests.MessageNestedApi.search was null, expected non-null MessageNested.',
              );
              try {
