...
// This file specifically tests the test GolubInstanceManager generated by core_tests.
    ...
    test('addHostCreatedInstance prevents already used objects and ids', () {
      ...
      expect(
        () => instanceManager.addHostCreatedInstance(
          CopyableObject(golub_instanceManager: instanceManager),
          0,
        ),
        throwsAssertionError,
      );
...
class CopyableObject extends GolubInternalProxyApiBaseClass {
  // ignore: non_constant_identifier_names
  CopyableObject({super.golub_instanceManager});

  @override
  // ignore: non_constant_identifier_names
  CopyableObject golub_copy() {
    return CopyableObject(golub_instanceManager: golub_instanceManager);
  }
}
