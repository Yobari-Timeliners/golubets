...
+ (instancetype)makeWithAField:(nullable id)aField {
  FLTUnusedClass *golubResult = [[FLTUnusedClass alloc] init];
  golubResult.aField = aField;
  return golubResult;
}
+ (FLTUnusedClass *)fromList:(NSArray<id> *)list {
  FLTUnusedClass *golubResult = [[FLTUnusedClass alloc] init];
  golubResult.aField = GetNullableObjectAtIndex(list, 0);
  return golubResult;
}
+ (nullable FLTUnusedClass *)nullableFromList:(NSArray<id> *)list {
...
+ (instancetype)makeWithABool:(BOOL)aBool
  ...
  FLTAllTypes *golubResult = [[FLTAllTypes alloc] init];
  golubResult.aBool = aBool;
  golubResult.anInt = anInt;
  golubResult.anInt64 = anInt64;
  golubResult.aDouble = aDouble;
  golubResult.aByteArray = aByteArray;
  golubResult.a4ByteArray = a4ByteArray;
  golubResult.a8ByteArray = a8ByteArray;
  golubResult.aFloatArray = aFloatArray;
  golubResult.anEnum = anEnum;
  golubResult.anotherEnum = anotherEnum;
  golubResult.aString = aString;
  golubResult.anObject = anObject;
  golubResult.list = list;
  golubResult.stringList = stringList;
  golubResult.intList = intList;
  golubResult.doubleList = doubleList;
  golubResult.boolList = boolList;
  golubResult.enumList = enumList;
  golubResult.objectList = objectList;
  golubResult.listList = listList;
  golubResult.mapList = mapList;
  golubResult.map = map;
  golubResult.stringMap = stringMap;
  golubResult.intMap = intMap;
  golubResult.enumMap = enumMap;
  golubResult.objectMap = objectMap;
  golubResult.listMap = listMap;
  golubResult.mapMap = mapMap;
  return golubResult;
}
+ (FLTAllTypes *)fromList:(NSArray<id> *)list {
  FLTAllTypes *golubResult = [[FLTAllTypes alloc] init];
  golubResult.aBool = [GetNullableObjectAtIndex(list, 0) boolValue];
  golubResult.anInt = [GetNullableObjectAtIndex(list, 1) integerValue];
  golubResult.anInt64 = [GetNullableObjectAtIndex(list, 2) integerValue];
  golubResult.aDouble = [GetNullableObjectAtIndex(list, 3) doubleValue];
  golubResult.aByteArray = GetNullableObjectAtIndex(list, 4);
  golubResult.a4ByteArray = GetNullableObjectAtIndex(list, 5);
  golubResult.a8ByteArray = GetNullableObjectAtIndex(list, 6);
  golubResult.aFloatArray = GetNullableObjectAtIndex(list, 7);
  FLTAnEnumBox *boxedFLTAnEnum = GetNullableObjectAtIndex(list, 8);
  golubResult.anEnum = boxedFLTAnEnum.value;
  FLTAnotherEnumBox *boxedFLTAnotherEnum = GetNullableObjectAtIndex(list, 9);
  golubResult.anotherEnum = boxedFLTAnotherEnum.value;
  golubResult.aString = GetNullableObjectAtIndex(list, 10);
  golubResult.anObject = GetNullableObjectAtIndex(list, 11);
  golubResult.list = GetNullableObjectAtIndex(list, 12);
  golubResult.stringList = GetNullableObjectAtIndex(list, 13);
  golubResult.intList = GetNullableObjectAtIndex(list, 14);
  golubResult.doubleList = GetNullableObjectAtIndex(list, 15);
  golubResult.boolList = GetNullableObjectAtIndex(list, 16);
  golubResult.enumList = GetNullableObjectAtIndex(list, 17);
  golubResult.objectList = GetNullableObjectAtIndex(list, 18);
  golubResult.listList = GetNullableObjectAtIndex(list, 19);
  golubResult.mapList = GetNullableObjectAtIndex(list, 20);
  golubResult.map = GetNullableObjectAtIndex(list, 21);
  golubResult.stringMap = GetNullableObjectAtIndex(list, 22);
  golubResult.intMap = GetNullableObjectAtIndex(list, 23);
  golubResult.enumMap = GetNullableObjectAtIndex(list, 24);
  golubResult.objectMap = GetNullableObjectAtIndex(list, 25);
  golubResult.listMap = GetNullableObjectAtIndex(list, 26);
  golubResult.mapMap = GetNullableObjectAtIndex(list, 27);
  return golubResult;
}
+ (nullable FLTAllTypes *)nullableFromList:(NSArray<id> *)list {
...
+ (instancetype)
  ...
  FLTAllNullableTypes *golubResult = [[FLTAllNullableTypes alloc] init];
  golubResult.aNullableBool = aNullableBool;
  golubResult.aNullableInt = aNullableInt;
  golubResult.aNullableInt64 = aNullableInt64;
  golubResult.aNullableDouble = aNullableDouble;
  golubResult.aNullableByteArray = aNullableByteArray;
  golubResult.aNullable4ByteArray = aNullable4ByteArray;
  golubResult.aNullable8ByteArray = aNullable8ByteArray;
  golubResult.aNullableFloatArray = aNullableFloatArray;
  golubResult.aNullableEnum = aNullableEnum;
  golubResult.anotherNullableEnum = anotherNullableEnum;
  golubResult.aNullableString = aNullableString;
  golubResult.aNullableObject = aNullableObject;
  golubResult.allNullableTypes = allNullableTypes;
  golubResult.list = list;
  golubResult.stringList = stringList;
  golubResult.intList = intList;
  golubResult.doubleList = doubleList;
  ...
  golubResult.listList = listList;
  golubResult.mapList = mapList;
  golubResult.recursiveClassList = recursiveClassList;
  golubResult.map = map;
  golubResult.stringMap = stringMap;
  golubResult.intMap = intMap;
  golubResult.enumMap = enumMap;
  ...
  golubResult.listMap = listMap;
  golubResult.mapMap = mapMap;
  golubResult.recursiveClassMap = recursiveClassMap;
  return golubResult;
}
+ (FLTAllNullableTypes *)fromList:(NSArray<id> *)list {
  FLTAllNullableTypes *golubResult = [[FLTAllNullableTypes alloc] init];
  golubResult.aNullableBool = GetNullableObjectAtIndex(list, 0);
  golubResult.aNullableInt = GetNullableObjectAtIndex(list, 1);
  golubResult.aNullableInt64 = GetNullableObjectAtIndex(list, 2);
  golubResult.aNullableDouble = GetNullableObjectAtIndex(list, 3);
  golubResult.aNullableByteArray = GetNullableObjectAtIndex(list, 4);
  golubResult.aNullable4ByteArray = GetNullableObjectAtIndex(list, 5);
  golubResult.aNullable8ByteArray = GetNullableObjectAtIndex(list, 6);
  golubResult.aNullableFloatArray = GetNullableObjectAtIndex(list, 7);
  golubResult.aNullableEnum = GetNullableObjectAtIndex(list, 8);
  golubResult.anotherNullableEnum = GetNullableObjectAtIndex(list, 9);
  golubResult.aNullableString = GetNullableObjectAtIndex(list, 10);
  golubResult.aNullableObject = GetNullableObjectAtIndex(list, 11);
  golubResult.allNullableTypes = GetNullableObjectAtIndex(list, 12);
  golubResult.list = GetNullableObjectAtIndex(list, 13);
  golubResult.stringList = GetNullableObjectAtIndex(list, 14);
  golubResult.intList = GetNullableObjectAtIndex(list, 15);
  golubResult.doubleList = GetNullableObjectAtIndex(list, 16);
  golubResult.boolList = GetNullableObjectAtIndex(list, 17);
  golubResult.enumList = GetNullableObjectAtIndex(list, 18);
  golubResult.objectList = GetNullableObjectAtIndex(list, 19);
  golubResult.listList = GetNullableObjectAtIndex(list, 20);
  golubResult.mapList = GetNullableObjectAtIndex(list, 21);
  golubResult.recursiveClassList = GetNullableObjectAtIndex(list, 22);
  golubResult.map = GetNullableObjectAtIndex(list, 23);
  golubResult.stringMap = GetNullableObjectAtIndex(list, 24);
  golubResult.intMap = GetNullableObjectAtIndex(list, 25);
  golubResult.enumMap = GetNullableObjectAtIndex(list, 26);
  golubResult.objectMap = GetNullableObjectAtIndex(list, 27);
  golubResult.listMap = GetNullableObjectAtIndex(list, 28);
  golubResult.mapMap = GetNullableObjectAtIndex(list, 29);
  golubResult.recursiveClassMap = GetNullableObjectAtIndex(list, 30);
  return golubResult;
}
+ (nullable FLTAllNullableTypes *)nullableFromList:(NSArray<id> *)list {
          ...
          aNullableObject:(nullable id)aNullableObject
               ...
               objectList:(nullable NSArray<id> *)objectList
                ...
                objectMap:(nullable NSDictionary<id, id> *)objectMap
                  listMap:(nullable NSDictionary<NSNumber *, NSArray<id> *> *)listMap
                   mapMap:(nullable NSDictionary<NSNumber *, NSDictionary<id, id> *> *)mapMap {
  FLTAllNullableTypesWithoutRecursion *golubResult =
                   ...
                   nullableClassList:
                    ...
                    nullableClassMap:
                        (nullable NSDictionary<NSNumber *, FLTAllNullableTypesWithoutRecursion *> *)
                            nullableClassMap {
  FLTAllClassesWrapper *golubResult = [[FLTAllClassesWrapper alloc] init];
  golubResult.allNullableTypes = allNullableTypes;
  golubResult.allNullableTypesWithoutRecursion = allNullableTypesWithoutRecursion;
  golubResult.allTypes = allTypes;
  golubResult.classList = classList;
  golubResult.nullableClassList = nullableClassList;
  golubResult.classMap = classMap;
  golubResult.nullableClassMap = nullableClassMap;
  return golubResult;
}
+ (FLTAllClassesWrapper *)fromList:(NSArray<id> *)list {
  FLTAllClassesWrapper *golubResult = [[FLTAllClassesWrapper alloc] init];
  golubResult.allNullableTypes = GetNullableObjectAtIndex(list, 0);
  golubResult.allNullableTypesWithoutRecursion = GetNullableObjectAtIndex(list, 1);
  golubResult.allTypes = GetNullableObjectAtIndex(list, 2);
  golubResult.classList = GetNullableObjectAtIndex(list, 3);
  golubResult.nullableClassList = GetNullableObjectAtIndex(list, 4);
  golubResult.classMap = GetNullableObjectAtIndex(list, 5);
  golubResult.nullableClassMap = GetNullableObjectAtIndex(list, 6);
  return golubResult;
}
+ (nullable FLTAllClassesWrapper *)nullableFromList:(NSArray<id> *)list {
                  ...
                  anotherEnum:(FLTAnotherEnum)anotherEnum
                   ...
                   objectList:(NSArray<id> *)objectList
                    ...
                    objectMap:(NSDictionary<id, id> *)objectMap
                      listMap:(NSDictionary<NSNumber *, NSArray<id> *> *)listMap
                       mapMap:(NSDictionary<NSNumber *, NSDictionary<id, id> *> *)mapMap {
  FLTImmutableAllTypes *golubResult = [[FLTImmutableAllTypes alloc] init];
  golubResult.aBool = aBool;
  golubResult.anInt = anInt;
  golubResult.anInt64 = anInt64;
  golubResult.aDouble = aDouble;
...
+ (FLTImmutableAllTypes *)fromList:(NSArray<id> *)list {
  ...
  golubResult.anotherEnum = boxedFLTAnotherEnum.value;
  golubResult.aString = GetNullableObjectAtIndex(list, 6);
  golubResult.anObject = GetNullableObjectAtIndex(list, 7);
  golubResult.list = GetNullableObjectAtIndex(list, 8);
  golubResult.stringList = GetNullableObjectAtIndex(list, 9);
  golubResult.intList = GetNullableObjectAtIndex(list, 10);
  golubResult.doubleList = GetNullableObjectAtIndex(list, 11);
  golubResult.boolList = GetNullableObjectAtIndex(list, 12);
  golubResult.enumList = GetNullableObjectAtIndex(list, 13);
  golubResult.objectList = GetNullableObjectAtIndex(list, 14);
  golubResult.listList = GetNullableObjectAtIndex(list, 15);
  golubResult.mapList = GetNullableObjectAtIndex(list, 16);
  golubResult.map = GetNullableObjectAtIndex(list, 17);
  golubResult.stringMap = GetNullableObjectAtIndex(list, 18);
  golubResult.intMap = GetNullableObjectAtIndex(list, 19);
  golubResult.enumMap = GetNullableObjectAtIndex(list, 20);
  golubResult.objectMap = GetNullableObjectAtIndex(list, 21);
  golubResult.listMap = GetNullableObjectAtIndex(list, 22);
  golubResult.mapMap = GetNullableObjectAtIndex(list, 23);
  return golubResult;
}
+ (nullable FLTImmutableAllTypes *)nullableFromList:(NSArray<id> *)list {
...
+ (instancetype)makeWithABool:(BOOL)aBool
  ...
  FLTAllTypesWithDefaults *golubResult = [[FLTAllTypesWithDefaults alloc] init];
  golubResult.aBool = aBool;
  golubResult.anInt = anInt;
  golubResult.anInt64 = anInt64;
  golubResult.aDouble = aDouble;
...
+ (FLTAllTypesWithDefaults *)fromList:(NSArray<id> *)list {
  ...
  golubResult.listMap = GetNullableObjectAtIndex(list, 22);
  golubResult.mapMap = GetNullableObjectAtIndex(list, 23);
  golubResult.allTypes = GetNullableObjectAtIndex(list, 24);
  return golubResult;
}
+ (nullable FLTAllTypesWithDefaults *)nullableFromList:(NSArray<id> *)list {
...
+ (instancetype)makeWithTestList:(nullable NSArray<id> *)testList {
  FLTTestMessage *golubResult = [[FLTTestMessage alloc] init];
  golubResult.testList = testList;
  return golubResult;
}
+ (FLTTestMessage *)fromList:(NSArray<id> *)list {
  FLTTestMessage *golubResult = [[FLTTestMessage alloc] init];
  golubResult.testList = GetNullableObjectAtIndex(list, 0);
  return golubResult;
}
+ (nullable FLTTestMessage *)nullableFromList:(NSArray<id> *)list {
...
@interface FLTCoreTestsGolubCodecReader : FlutterStandardReader
@end
@implementation FLTCoreTestsGolubCodecReader
...
@interface FLTCoreTestsGolubCodecWriter : FlutterStandardWriter
@end
@implementation FLTCoreTestsGolubCodecWriter
...
@interface FLTCoreTestsGolubCodecReaderWriter : FlutterStandardReaderWriter
@end
@implementation FLTCoreTestsGolubCodecReaderWriter
- (FlutterStandardWriter *)writerWithData:(NSMutableData *)data {
  return [[FLTCoreTestsGolubCodecWriter alloc] initWithData:data];
}
- (FlutterStandardReader *)readerWithData:(NSData *)data {
  return [[FLTCoreTestsGolubCodecReader alloc] initWithData:data];
}
@end
...
NSObject<FlutterMessageCodec> *FLTGetCoreTestsCodec(void) {
  ...
  dispatch_once(&sPred, ^{
    FLTCoreTestsGolubCodecReaderWriter *readerWriter =
        [[FLTCoreTestsGolubCodecReaderWriter alloc] init];
  ...
  /// test basic calling.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golub.golub_integration_tests."
...
void SetUpFLTHostSmallApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger,
                             ...
                             : @"";
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:
                                      @"%@%@",
                                      @"dev.bayori.golub.golub_integration_tests.HostSmallApi.echo",
                                      messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
