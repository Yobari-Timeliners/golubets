...
public class CoreTests {
  ...
  public static final class ImmutableAllTypes {
    ...
    public boolean equals(Object o) {
      ...
      return aBool.equals(that.aBool) && anInt.equals(that.anInt) && anInt64.equals(that.anInt64) && aDouble.equals(that.aDouble) && anEnum.equals(that.anEnum) && anotherEnum.equals(that.anotherEnum) && aString.equals(that.aString) && anObject.equals(that.anObject) && list.equals(that.list) && stringList.equals(that.stringList) && intList.equals(that.intList) && doubleList.equals(that.doubleList) && boolList.equals(that.boolList) && enumList.equals(that.enumList) && objectList.equals(that.objectList) && listList.equals(that.listList) && mapList.equals(that.mapList) && map.equals(that.map) && stringMap.equals(that.stringMap) && intMap.equals(that.intMap) && enumMap.equals(that.enumMap) && objectMap.equals(that.objectMap) && listMap.equals(that.listMap) && mapMap.equals(that.mapMap);
    }

    @Override
    public int hashCode() {
      return Objects.hash(aBool, anInt, anInt64, aDouble, anEnum, anotherEnum, aString, anObject, list, stringList, intList, doubleList, boolList, enumList, objectList, listList, mapList, map, stringMap, intMap, enumMap, objectMap, listMap, mapMap);
    }
  ...
  public static final class AllTypesWithDefaults {
    ...
    public boolean equals(Object o) {
      ...
      return aBool.equals(that.aBool) && anInt.equals(that.anInt) && anInt64.equals(that.anInt64) && aDouble.equals(that.aDouble) && anEnum.equals(that.anEnum) && anotherEnum.equals(that.anotherEnum) && aString.equals(that.aString) && anObject.equals(that.anObject) && list.equals(that.list) && stringList.equals(that.stringList) && intList.equals(that.intList) && doubleList.equals(that.doubleList) && boolList.equals(that.boolList) && enumList.equals(that.enumList) && objectList.equals(that.objectList) && listList.equals(that.listList) && mapList.equals(that.mapList) && map.equals(that.map) && stringMap.equals(that.stringMap) && intMap.equals(that.intMap) && enumMap.equals(that.enumMap) && objectMap.equals(that.objectMap) && listMap.equals(that.listMap) && mapMap.equals(that.mapMap) && allTypes.equals(that.allTypes);
    }

    @Override
    public int hashCode() {
      return Objects.hash(aBool, anInt, anInt64, aDouble, anEnum, anotherEnum, aString, anObject, list, stringList, intList, doubleList, boolList, enumList, objectList, listList, mapList, map, stringMap, intMap, enumMap, objectMap, listMap, mapMap, allTypes);
    }
  ...
  public interface HostIntegrationCoreApi {
     ...
     */
    void echoModernAsyncAllTypesAndNotThrow(@NonNull AllTypes everything, @NonNull Result<AllTypes> result);
    /**
     * Returns the passed object, to test async serialization and deserialization using `await`-style
     * and throws an exception.
     */
    void echoModernAsyncAllTypesAndThrow(@NonNull AllTypes everything, @NonNull Result<AllTypes> result);
    /** Returns the passed object, to test serialization and deserialization. */
     ...
     * and Swift does not throw an exception.
     */
    void echoModernAsyncNullableAllNullableTypes(@Nullable AllNullableTypes everything, @NonNull NullableResult<AllNullableTypes> result);
    /** Returns the passed object, to test serialization and deserialization. */
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable HostIntegrationCoreApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.createAllTypesWithDefaults" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAllTypesWithDefaults" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoModernAsyncAllTypes" + messageChannelSuffix, getCodec(), taskQueue);
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoModernAsyncAllTypesAndNotThrow" + messageChannelSuffix, getCodec(), taskQueue);
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoModernAsyncAllTypesAndThrow" + messageChannelSuffix, getCodec(), taskQueue);
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoModernAsyncNullableAllNullableTypes" + messageChannelSuffix, getCodec(), taskQueue);
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
