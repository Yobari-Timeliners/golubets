...
private func wrapError(_ error: Any) -> [Any?] {
  if let golubError = error as? EventChannelTestsError {
    return [
      golubError.code,
      golubError.message,
      golubError.details,
...
public class EventAllNullableTypes: Hashable {
  ...
  static func fromList(_ golubVar_list: [Any?]) -> EventAllNullableTypes? {
    ...
    let aNullableEnum: EventEnum? = nilOrValue(golubVar_list[8])
    let anotherNullableEnum: AnotherEventEnum? = nilOrValue(golubVar_list[9])
    let aNullableString: String? = nilOrValue(golubVar_list[10])
    let aNullableObject: Any? = golubVar_list[11]
    let allNullableTypes: EventAllNullableTypes? = nilOrValue(golubVar_list[12])
    ...
    let enumList: [EventEnum?]? = nilOrValue(golubVar_list[18])
    ...
    let recursiveClassList: [EventAllNullableTypes?]? = nilOrValue(golubVar_list[22])
    ...
    let enumMap: [EventEnum?: EventEnum?]? = golubVar_list[26] as? [EventEnum?: EventEnum?]
    ...
    let recursiveClassMap: [Int64?: EventAllNullableTypes?]? = nilOrValue(golubVar_list[30])
...
private class EventChannelTestsGolubCodecReader: FlutterStandardReader {
...
private class EventChannelTestsGolubCodecWriter: FlutterStandardWriter {
...
private class EventChannelTestsGolubCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return EventChannelTestsGolubCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return EventChannelTestsGolubCodecWriter(data: data)
  }
}

class EventChannelTestsGolubCodec: FlutterStandardMessageCodec, @unchecked Sendable {
  static let shared = EventChannelTestsGolubCodec(
    readerWriter: EventChannelTestsGolubCodecReaderWriter())
}

var eventChannelTestsGolubMethodCodec = FlutterStandardMethodCodec(
  readerWriter: EventChannelTestsGolubCodecReaderWriter())
...
class StreamIntsStreamHandler: GolubEventChannelWrapper<Int64> {
  static func register(
    with messenger: FlutterBinaryMessenger,
    instanceName: String = "",
    streamHandler: StreamIntsStreamHandler
  ) {
    var channelName = "dev.bayori.golub.golub_integration_tests.EventChannelMethods.streamInts"
    if !instanceName.isEmpty {
      channelName += ".\(instanceName)"
    }
    let internalStreamHandler = GolubStreamHandler<Int64>(wrapper: streamHandler)
    let channel = FlutterEventChannel(
      name: channelName, binaryMessenger: messenger, codec: eventChannelTestsGolubMethodCodec)
    channel.setStreamHandler(internalStreamHandler)
  }
}

class StreamEventsStreamHandler: GolubEventChannelWrapper<PlatformEvent> {
  static func register(
    with messenger: FlutterBinaryMessenger,
    instanceName: String = "",
    streamHandler: StreamEventsStreamHandler
  ) {
    var channelName = "dev.bayori.golub.golub_integration_tests.EventChannelMethods.streamEvents"
    if !instanceName.isEmpty {
      channelName += ".\(instanceName)"
    }
    let internalStreamHandler = GolubStreamHandler<PlatformEvent>(wrapper: streamHandler)
    let channel = FlutterEventChannel(
      name: channelName, binaryMessenger: messenger, codec: eventChannelTestsGolubMethodCodec)
    channel.setStreamHandler(internalStreamHandler)
  }
...
class StreamConsistentNumbersStreamHandler: GolubEventChannelWrapper<Int64> {
  static func register(
    with messenger: FlutterBinaryMessenger,
    instanceName: String = "",
...
public class SealedClassApiSetup {
  static var codec: FlutterStandardMessageCodec { EventChannelTestsGolubCodec.shared }
  ...
  public static func setUp(
    ...
    let echoChannel = FlutterBasicMessageChannel(
      name: "dev.bayori.golub.golub_integration_tests.SealedClassApi.echo\(channelSuffix)",
