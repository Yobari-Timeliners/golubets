...
private class ProxyApiTestsPigeonInstanceManagerApi {
  ...
  public func removeStrongReference(identifier identifierArg: Int64, completion: @escaping (Result<Void, ProxyApiTestsError>) -> Void) {
...
withIdentifier: pigeonIdentifierArg)
  ...
  public func pigeonNewInstance(pigeonInstance: ProxyApiTestClass, completion: @escaping (Result<Void, ProxyApiTestsError>) -> Void) {
...
withIdentifier: pigeonIdentifierArg)
  ...
  public func pigeonNewInstance(pigeonInstance: ProxyApiSuperClass, completion: @escaping (Result<Void, ProxyApiTestsError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          ProxyApiTestsError(
...
final class PigeonApiProxyApiInterface: PigeonApiProtocolProxyApiInterface  {
  ...
  public func pigeonNewInstance(pigeonInstance: ProxyApiInterface, completion: @escaping (Result<Void, ProxyApiTestsError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          ProxyApiTestsError(
...
withIdentifier: pigeonIdentifierArg)
  ...
  @available(iOS 15.0.0, macOS 10.0.0, *)
  public func pigeonNewInstance(pigeonInstance: ClassWithApiRequirement, completion: @escaping (Result<Void, ProxyApiTestsError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          ProxyApiTestsError(
