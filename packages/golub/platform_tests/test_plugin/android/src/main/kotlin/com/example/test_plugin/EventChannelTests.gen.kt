...
private object EventChannelTestsGolubUtils {
...
data class EventAllNullableTypes(
  ...
  companion object {
    fun fromList(golubVar_list: List<Any?>): EventAllNullableTypes {
      ...
      val aNullableEnum = golubVar_list[8] as EventEnum?
      val anotherNullableEnum = golubVar_list[9] as AnotherEventEnum?
      val aNullableString = golubVar_list[10] as String?
      val aNullableObject = golubVar_list[11]
      val allNullableTypes = golubVar_list[12] as EventAllNullableTypes?
      ...
      val enumList = golubVar_list[18] as List<EventEnum?>?
      ...
      val recursiveClassList = golubVar_list[22] as List<EventAllNullableTypes?>?
      ...
      val enumMap = golubVar_list[26] as Map<EventEnum?, EventEnum?>?
      ...
      val recursiveClassMap = golubVar_list[30] as Map<Long?, EventAllNullableTypes?>?
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return EventChannelTestsGolubUtils.deepEquals(toList(), other.toList())
  }
...
/**
 * Generated class from Golub that represents data sent in messages. This class should not be
...
data class IntEvent(val value: Long) : PlatformEvent() {
  companion object {
    fun fromList(golubVar_list: List<Any?>): IntEvent {
      val value = golubVar_list[0] as Long
...
data class StringEvent(val value: String) : PlatformEvent() {
  companion object {
    fun fromList(golubVar_list: List<Any?>): StringEvent {
      val value = golubVar_list[0] as String
...
data class BoolEvent(val value: Boolean) : PlatformEvent() {
  companion object {
    fun fromList(golubVar_list: List<Any?>): BoolEvent {
      val value = golubVar_list[0] as Boolean
...
data class DoubleEvent(val value: Double) : PlatformEvent() {
  companion object {
    fun fromList(golubVar_list: List<Any?>): DoubleEvent {
      val value = golubVar_list[0] as Double
...
data class ObjectsEvent(val value: Any) : PlatformEvent() {
  companion object {
    fun fromList(golubVar_list: List<Any?>): ObjectsEvent {
      val value = golubVar_list[0] as Any
...
data class EnumEvent(val value: EventEnum) : PlatformEvent() {
  companion object {
    fun fromList(golubVar_list: List<Any?>): EnumEvent {
      val value = golubVar_list[0] as EventEnum
...
data class ClassEvent(val value: EventAllNullableTypes) : PlatformEvent() {
  companion object {
    fun fromList(golubVar_list: List<Any?>): ClassEvent {
      val value = golubVar_list[0] as EventAllNullableTypes
...
class EmptyEvent() : PlatformEvent() {
  companion object {
    ...
    fun fromList(golubVar_list: List<Any?>): EmptyEvent {
      return EmptyEvent()
    }
  }
...
private open class EventChannelTestsGolubCodec : StandardMessageCodec() {
...
val EventChannelTestsGolubMethodCodec = StandardMethodCodec(EventChannelTestsGolubCodec())

private class EventChannelTestsGolubStreamHandler<T>(
    val wrapper: EventChannelTestsGolubEventChannelWrapper<T>
...
interface EventChannelTestsGolubEventChannelWrapper<T> {
...
abstract class StreamIntsStreamHandler : EventChannelTestsGolubEventChannelWrapper<Long> {
  companion object {
    fun register(
      ...
      var channelName: String =
          "dev.bayori.golub.golub_integration_tests.EventChannelMethods.streamInts"
      if (instanceName.isNotEmpty()) {
        channelName += ".$instanceName"
      }
      val internalStreamHandler = EventChannelTestsGolubStreamHandler<Long>(streamHandler)
      EventChannel(messenger, channelName, EventChannelTestsGolubMethodCodec)
...
abstract class StreamEventsStreamHandler :
    EventChannelTestsGolubEventChannelWrapper<PlatformEvent> {
  companion object {
    fun register(
        messenger: BinaryMessenger,
      ...
      var channelName: String =
          "dev.bayori.golub.golub_integration_tests.EventChannelMethods.streamEvents"
      if (instanceName.isNotEmpty()) {
        channelName += ".$instanceName"
      }
      val internalStreamHandler = EventChannelTestsGolubStreamHandler<PlatformEvent>(streamHandler)
      EventChannel(messenger, channelName, EventChannelTestsGolubMethodCodec)
          .setStreamHandler(internalStreamHandler)
    }
  }
...
abstract class StreamConsistentNumbersStreamHandler :
    EventChannelTestsGolubEventChannelWrapper<Long> {
  companion object {
    fun register(
        messenger: BinaryMessenger,
      ...
      var channelName: String =
          "dev.bayori.golub.golub_integration_tests.EventChannelMethods.streamConsistentNumbers"
      if (instanceName.isNotEmpty()) {
        channelName += ".$instanceName"
      }
      val internalStreamHandler = EventChannelTestsGolubStreamHandler<Long>(streamHandler)
...
interface SealedClassApi {
  ...
  companion object {
    ...
    val codec: MessageCodec<Any?> by lazy { EventChannelTestsGolubCodec() }
      ...
      run {
        val channel =
            BasicMessageChannel<Any?>(
                binaryMessenger,
                "dev.bayori.golub.golub_integration_tests.SealedClassApi.echo$separatedMessageChannelSuffix",
                codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> =
                try {
                  ...
                  EventChannelTestsGolubUtils.wrapError(exception)
                }
            reply.reply(wrapped)
          }
        } else {
