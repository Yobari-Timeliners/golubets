...
namespace core_tests_golub_test {
...
GolubCodecSerializer::GolubCodecSerializer() {}

EncodableValue GolubCodecSerializer::ReadValueOfType(
...
void GolubCodecSerializer::WriteValue(const EncodableValue& value,
...
const flutter::StandardMessageCodec& HostIntegrationCoreApi::GetCodec() {
  return flutter::StandardMessageCodec::GetInstance(
      &GolubCodecSerializer::GetInstance());
}
...
// Generated class from Golub that represents Flutter messages that can be
// called from C++.
