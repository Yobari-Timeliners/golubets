...
class ImmutableAllTypes {
 ...
 private:
  static ImmutableAllTypes FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
...
class AllTypesWithDefaults {
 public:
  ...
  AllTypesWithDefaults& operator=(AllTypesWithDefaults&& other) noexcept = default;
  bool a_bool() const;
  void set_a_bool(bool value_arg);
 ...
 private:
  static AllTypesWithDefaults FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class HostIntegrationCoreApi;
  friend class FlutterIntegrationCoreApi;
  friend class HostTrivialApi;
...
class HostIntegrationCoreApi {
 public:
  ...
  virtual ErrorOr<AllTypesWithDefaults> EchoAllTypesWithDefaults(const AllTypesWithDefaults& all_types) = 0;
  // Returns passed in int.
