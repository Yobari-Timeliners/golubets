...
class UnusedClass {
 ...
 private:
  ...
  friend class HostSmallApi;
  friend class FlutterSmallApi;
  friend class GolubCodecSerializer;
...
class GolubCodecSerializer : public flutter::StandardCodecSerializer {
 public:
  GolubCodecSerializer();
  inline static GolubCodecSerializer& GetInstance() {
    static GolubCodecSerializer sInstance;
    return sInstance;
  }
...
//
// Generated interface from Golub that represents a handler of messages from
// Flutter.
