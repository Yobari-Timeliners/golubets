...
public struct MessageData: Hashable {
  ...
  static func fromList(_ golubVar_list: [Any?]) -> MessageData? {
    let name: String? = nilOrValue(golubVar_list[0])
    let description: String? = nilOrValue(golubVar_list[1])
    let code = golubVar_list[2] as! Code
    let data = golubVar_list[3] as! [String: String]
...
private class MessagesGolubCodecReader: FlutterStandardReader {
...
private class MessagesGolubCodecWriter: FlutterStandardWriter {
...
private class MessagesGolubCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return MessagesGolubCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return MessagesGolubCodecWriter(data: data)
  }
}

class MessagesGolubCodec: FlutterStandardMessageCodec, @unchecked Sendable {
  static let shared = MessagesGolubCodec(readerWriter: MessagesGolubCodecReaderWriter())
}
...
public class ExampleHostApiSetup {
  static var codec: FlutterStandardMessageCodec { MessagesGolubCodec.shared }
  ...
  public static func setUp(
    ...
    let getHostLanguageChannel = FlutterBasicMessageChannel(
      name: "dev.bayori.golub.golub_example_package.ExampleHostApi.getHostLanguage\(channelSuffix)",
    ...
    let addChannel = FlutterBasicMessageChannel(
      name: "dev.bayori.golub.golub_example_package.ExampleHostApi.add\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let sendMessageChannel = FlutterBasicMessageChannel(
      name: "dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessage\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let sendMessageModernAsyncChannel =
      ...
      ? FlutterBasicMessageChannel(
        name:
          "dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessageModernAsync\(channelSuffix)",
        binaryMessenger: binaryMessenger, codec: codec)
      : FlutterBasicMessageChannel(
        name:
          "dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessageModernAsync\(channelSuffix)",
    ...
    let sendMessageModernAsyncThrowsChannel =
      ...
      ? FlutterBasicMessageChannel(
        name:
          "dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessageModernAsyncThrows\(channelSuffix)",
        binaryMessenger: binaryMessenger, codec: codec)
      : FlutterBasicMessageChannel(
        name:
          "dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessageModernAsyncThrows\(channelSuffix)",
...
public class MessageFlutterApi: MessageFlutterApiProtocol {
  ...
  var codec: MessagesGolubCodec {
    return MessagesGolubCodec.shared
  }
  public func flutterMethod(
    aString aStringArg: String?, completion: @escaping (Result<String, GolubError>) -> Void
  ) {
    let channelName: String =
      "dev.bayori.golub.golub_example_package.MessageFlutterApi.flutterMethod\(messageChannelSuffix)"
