...
class ExampleHostApi {
  ...
  Future<String> getHostLanguage() async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_example_package.ExampleHostApi.getHostLanguage$golubVar_messageChannelSuffix';
  ...
  Future<int> add(int a, int b) async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_example_package.ExampleHostApi.add$golubVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> golubVar_channel =
        BasicMessageChannel<Object?>(
          golubVar_channelName,
          golubChannelCodec,
  ...
  Future<bool> sendMessage(MessageData message) async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessage$golubVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> golubVar_channel =
        BasicMessageChannel<Object?>(
          golubVar_channelName,
          golubChannelCodec,
  ...
  Future<bool> sendMessageModernAsync(MessageData message) async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessageModernAsync$golubVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> golubVar_channel =
        BasicMessageChannel<Object?>(
          golubVar_channelName,
          golubChannelCodec,
  ...
  Future<bool> sendMessageModernAsyncThrows(MessageData message) async {
    final String golubVar_channelName =
        'dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessageModernAsyncThrows$golubVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> golubVar_channel =
        BasicMessageChannel<Object?>(
          golubVar_channelName,
          golubChannelCodec,
        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      if (api == null) {
        ...
        golubVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.bayori.golub.golub_example_package.MessageFlutterApi.flutterMethod was null.',
          );
