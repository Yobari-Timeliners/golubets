  ...
  public static final class MessageData {
    ...
    public static final class Builder {
      ...
      public @NonNull MessageData build() {
        MessageData golubReturn = new MessageData();
        golubReturn.setName(name);
        golubReturn.setDescription(description);
        golubReturn.setCode(code);
        golubReturn.setData(data);
        return golubReturn;
      }
    }
    ...
    static @NonNull MessageData fromList(@NonNull ArrayList<Object> golubVar_list) {
      MessageData golubResult = new MessageData();
      Object name = golubVar_list.get(0);
      golubResult.setName((String) name);
      Object description = golubVar_list.get(1);
      golubResult.setDescription((String) description);
      Object code = golubVar_list.get(2);
      golubResult.setCode((Code) code);
      Object data = golubVar_list.get(3);
      golubResult.setData((Map<String, String>) data);
      return golubResult;
    }
  }
    ...
    static void setUp(
      ...
      BinaryMessenger.TaskQueue taskQueue = binaryMessenger.makeBackgroundTaskQueue();
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.bayori.golub.golub_example_package.ExampleHostApi.getHostLanguage"
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.bayori.golub.golub_example_package.ExampleHostApi.add" + messageChannelSuffix,
                getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessage"
                    + messageChannelSuffix,
                getCodec());
        if (api != null) {
          channel.setMessageHandler(
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessageModernAsync"
                    + messageChannelSuffix,
                getCodec(),
                taskQueue);
        if (api != null) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.bayori.golub.golub_example_package.ExampleHostApi.sendMessageModernAsyncThrows"
                    + messageChannelSuffix,
                getCodec(),
                taskQueue);
        if (api != null) {
