...
class Api {
  ...
  Future<FlutterSearchReply> search(FlutterSearchRequest request) async {
    final golubetsVar_channelName =
        'dev.bayori.golubets.golubets_integration_tests.Api.search$golubetsVar_messageChannelSuffix';
    ...
    return golubetsVar_replyValue! as FlutterSearchReply;
  }

  Future<FlutterSearchReplies> doSearches(FlutterSearchRequests request) async {
    final golubetsVar_channelName =
        'dev.bayori.golubets.golubets_integration_tests.Api.doSearches$golubetsVar_messageChannelSuffix';
    final golubetsVar_channel = BasicMessageChannel<Object?>(
      golubetsVar_channelName,
      golubetsChannelCodec,
      binaryMessenger: golubetsVar_binaryMessenger,
    ...
    return golubetsVar_replyValue! as FlutterSearchReplies;
  }

  Future<FlutterSearchRequests> echo(FlutterSearchRequests requests) async {
    final golubetsVar_channelName =
        'dev.bayori.golubets.golubets_integration_tests.Api.echo$golubetsVar_messageChannelSuffix';
    final golubetsVar_channel = BasicMessageChannel<Object?>(
      golubetsVar_channelName,
      golubetsChannelCodec,
      binaryMessenger: golubetsVar_binaryMessenger,
    ...
    return golubetsVar_replyValue! as FlutterSearchRequests;
  }

  Future<int> anInt(int value) async {
    final golubetsVar_channelName =
        'dev.bayori.golubets.golubets_integration_tests.Api.anInt$golubetsVar_messageChannelSuffix';
    final golubetsVar_channel = BasicMessageChannel<Object?>(
      golubetsVar_channelName,
      golubetsChannelCodec,
      binaryMessenger: golubetsVar_binaryMessenger,
