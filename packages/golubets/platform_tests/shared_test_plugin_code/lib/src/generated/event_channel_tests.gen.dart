...
Stream<int> streamInts({String instanceName = ''}) {
  ...
  final EventChannel streamIntsChannel = EventChannel(
    'dev.bayori.golubets.golubets_integration_tests.EventChannelMethods.streamInts$instanceName',
    golubetsMethodCodec,
  );
...
Stream<PlatformEvent> streamEvents({String instanceName = ''}) {
  ...
  final EventChannel streamEventsChannel = EventChannel(
    'dev.bayori.golubets.golubets_integration_tests.EventChannelMethods.streamEvents$instanceName',
    golubetsMethodCodec,
  );
...
Stream<int> streamConsistentNumbers({String instanceName = ''}) {
  ...
  final EventChannel streamConsistentNumbersChannel = EventChannel(
    'dev.bayori.golubets.golubets_integration_tests.EventChannelMethods.streamConsistentNumbers$instanceName',
    golubetsMethodCodec,
  );
...
class SealedClassApi {
  ...
  Future<PlatformEvent> echo(PlatformEvent event) async {
    final String golubetsVar_channelName =
        'dev.bayori.golubets.golubets_integration_tests.SealedClassApi.echo$golubetsVar_messageChannelSuffix';
    ...
    if (golubetsVar_replyList == null) {
      ...
      return (golubetsVar_replyList[0] as PlatformEvent?)!;
    }
  }
}
