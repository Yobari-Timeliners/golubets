...
std::ostream& operator<<(std::ostream& os, const ImmutableAllTypes& obj) {
  os << "ImmutableAllTypes(";
  os << "a_bool: ";
  os << PigeonInternalToString(obj.a_bool_);
  os << ", an_int: ";
  os << PigeonInternalToString(obj.an_int_);
...
AllTypesWithDefaults& AllTypesWithDefaults::operator=(
    const AllTypesWithDefaults& other) {
  a_bool_ = other.a_bool_;
  an_int_ = other.an_int_;
  an_int64_ = other.an_int64_;
  a_double_ = other.a_double_;
...
bool AllTypesWithDefaults::a_bool() const { return a_bool_; }

void AllTypesWithDefaults::set_a_bool(bool value_arg) { a_bool_ = value_arg; }

int64_t AllTypesWithDefaults::an_int() const { return an_int_; }

void AllTypesWithDefaults::set_an_int(int64_t value_arg) {
  an_int_ = value_arg;
}

int64_t AllTypesWithDefaults::an_int64() const { return an_int64_; }

void AllTypesWithDefaults::set_an_int64(int64_t value_arg) {
  an_int64_ = value_arg;
}

double AllTypesWithDefaults::a_double() const { return a_double_; }

void AllTypesWithDefaults::set_a_double(double value_arg) {
  a_double_ = value_arg;
}

const AnEnum& AllTypesWithDefaults::an_enum() const { return an_enum_; }
...
const std::string& AllTypesWithDefaults::a_string() const { return a_string_; }
...
const EncodableList& AllTypesWithDefaults::list() const { return list_; }
...
const EncodableMap& AllTypesWithDefaults::map() const { return map_; }
...
const EncodableMap& AllTypesWithDefaults::int_map() const { return int_map_; }

void AllTypesWithDefaults::set_int_map(const EncodableMap& value_arg) {
  int_map_ = value_arg;
}

const EncodableMap& AllTypesWithDefaults::enum_map() const { return enum_map_; }
...
const EncodableMap& AllTypesWithDefaults::list_map() const { return list_map_; }

void AllTypesWithDefaults::set_list_map(const EncodableMap& value_arg) {
  list_map_ = value_arg;
}

const EncodableMap& AllTypesWithDefaults::map_map() const { return map_map_; }
...
AllTypesWithDefaults AllTypesWithDefaults::FromEncodableList(
    const EncodableList& list) {
  AllTypesWithDefaults decoded(
      ...
      std::get<EncodableMap>(list[21]), std::get<EncodableMap>(list[22]),
      std::get<EncodableMap>(list[23]),
      std::any_cast<const ImmutableAllTypes&>(
...
std::ostream& operator<<(std::ostream& os, const AllTypesWithDefaults& obj) {
  os << "AllTypesWithDefaults(";
  os << "a_bool: ";
  os << PigeonInternalToString(obj.a_bool_);
  os << ", an_int: ";
  os << PigeonInternalToString(obj.an_int_);
      ...
      channel.SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const auto& all_types_arg =
                  std::any_cast<const AllTypesWithDefaults&>(
                      std::get<CustomEncodableValue>(encodable_all_types_arg));
              ErrorOr<AllTypesWithDefaults> output =
                  api->EchoAllTypesWithDefaults(all_types_arg);
              if (output.has_error()) {
                reply(WrapError(output.error()));
                return;
              }
...
void FlutterIntegrationCoreApi::Noop(
  ...
  const std::string channel_name =
      ...
      "FlutterIntegrationCoreApi.noop" +
...
void FlutterIntegrationCoreApi::ThrowError(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.throwError" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue();
  channel.Send(
...
void FlutterIntegrationCoreApi::EchoAllTypes(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoAllTypes" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
...
void FlutterIntegrationCoreApi::SendMultipleNullableTypesWithoutRecursion(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.sendMultipleNullableTypesWithoutRecursion" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
      a_nullable_bool_arg ? EncodableValue(*a_nullable_bool_arg)
...
void FlutterIntegrationCoreApi::EchoInt(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoInt" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoString(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoString" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoUint8List(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoUint8List" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoList(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoList" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
      EncodableValue(list_arg),
...
void FlutterIntegrationCoreApi::EchoEnumList(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoEnumList" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoClassList(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoClassList" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoMap(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoMap" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoStringMap(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoStringMap" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoIntMap(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoIntMap" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoEnumMap(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoEnumMap" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoClassMap(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoClassMap" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::EchoEnum(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.echoEnum" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue(EncodableList{
...
void FlutterIntegrationCoreApi::NoopAsync(
  ...
  const std::string channel_name =
      "dev.bayori.golubets.golubets_integration_tests."
      "FlutterIntegrationCoreApi.noopAsync" +
      message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
  EncodableValue encoded_api_arguments = EncodableValue();
  channel.Send(
