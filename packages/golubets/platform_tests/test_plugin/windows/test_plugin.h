...
class TestPlugin : public flutter::Plugin,
                   public core_tests_golubetstest::HostIntegrationCoreApi {
 public:
  ...
  EchoAllNullableTypes(
      const core_tests_golubetstest::AllNullableTypes* everything) override;
  core_tests_golubetstest::ErrorOr<
      std::optional<core_tests_golubetstest::AllNullableTypesWithoutRecursion>>
  EchoAllNullableTypesWithoutRecursion(
      const core_tests_golubetstest::AllNullableTypesWithoutRecursion*
          everything) override;
  core_tests_golubetstest::ErrorOr<std::optional<flutter::EncodableValue>>
  ThrowError() override;
  std::optional<core_tests_golubetstest::FlutterError> ThrowErrorFromVoid()
      override;
  core_tests_golubetstest::ErrorOr<std::optional<flutter::EncodableValue>>
  ...
  core_tests_golubetstest::ErrorOr<std::vector<uint8_t>> EchoUint8List(
      const std::vector<uint8_t>& a_uint8_list) override;
  core_tests_golubetstest::ErrorOr<flutter::EncodableValue> EchoObject(
  ...
  core_tests_golubetstest::ErrorOr<flutter::EncodableMap> EchoIntMap(
      const flutter::EncodableMap& int_map) override;
  core_tests_golubetstest::ErrorOr<flutter::EncodableMap> EchoEnumMap(
      const flutter::EncodableMap& enum_map) override;
  core_tests_golubetstest::ErrorOr<flutter::EncodableMap> EchoClassMap(
      const flutter::EncodableMap& class_map) override;
  core_tests_golubetstest::ErrorOr<flutter::EncodableMap> EchoNonNullStringMap(
      const flutter::EncodableMap& string_map) override;
  core_tests_golubetstest::ErrorOr<flutter::EncodableMap> EchoNonNullIntMap(
      const flutter::EncodableMap& int_map) override;
  core_tests_golubetstest::ErrorOr<flutter::EncodableMap> EchoNonNullEnumMap(
      const flutter::EncodableMap& enum_map) override;
  core_tests_golubetstest::ErrorOr<flutter::EncodableMap> EchoNonNullClassMap(
      const flutter::EncodableMap& class_map) override;
  core_tests_golubetstest::ErrorOr<core_tests_golubetstest::AllClassesWrapper>
  EchoClassWrapper(
      const core_tests_golubetstest::AllClassesWrapper& wrapper) override;
  core_tests_golubetstest::ErrorOr<core_tests_golubetstest::AnEnum> EchoEnum(
      const core_tests_golubetstest::AnEnum& an_enum) override;
  core_tests_golubetstest::ErrorOr<core_tests_golubetstest::AnotherEnum>
  EchoAnotherEnum(
      const core_tests_golubetstest::AnotherEnum& another_enum) override;
  core_tests_golubetstest::ErrorOr<std::string> EchoNamedDefaultString(
      const std::string& a_string) override;
  core_tests_golubetstest::ErrorOr<double> EchoOptionalDefaultDouble(
      double a_double) override;
  core_tests_golubetstest::ErrorOr<
      core_tests_golubetstest::AllTypesWithDefaults>
  CreateAllTypesWithDefaults() override;
  core_tests_golubetstest::ErrorOr<
      core_tests_golubetstest::AllTypesWithDefaults>
  EchoAllTypesWithDefaults(
      const core_tests_golubetstest::AllTypesWithDefaults& all_types) override;
  core_tests_golubetstest::ErrorOr<int64_t> EchoRequiredInt(
      int64_t an_int) override;
  core_tests_golubetstest::ErrorOr<std::optional<std::string>>
  ExtractNestedNullableString(
      const core_tests_golubetstest::AllClassesWrapper& wrapper) override;
  core_tests_golubetstest::ErrorOr<core_tests_golubetstest::AllClassesWrapper>
  CreateNestedNullableString(const std::string* nullable_string) override;
  core_tests_golubetstest::ErrorOr<core_tests_golubetstest::AllNullableTypes>
  ...
  core_tests_golubetstest::ErrorOr<
      core_tests_golubetstest::AllNullableTypesWithoutRecursion>
  SendMultipleNullableTypesWithoutRecursion(
      const bool* a_nullable_bool, const int64_t* a_nullable_int,
      const std::string* a_nullable_string) override;
  core_tests_golubetstest::ErrorOr<std::optional<int64_t>> EchoNullableInt(
      const int64_t* a_nullable_int) override;
  core_tests_golubetstest::ErrorOr<std::optional<double>> EchoNullableDouble(
      const double* a_nullable_double) override;
  core_tests_golubetstest::ErrorOr<std::optional<bool>> EchoNullableBool(
      const bool* a_nullable_bool) override;
  core_tests_golubetstest::ErrorOr<std::optional<std::string>>
  EchoNullableString(const std::string* a_nullable_string) override;
  core_tests_golubetstest::ErrorOr<std::optional<std::vector<uint8_t>>>
  ...
  core_tests_golubetstest::ErrorOr<std::optional<flutter::EncodableList>>
  ...
  core_tests_golubetstest::ErrorOr<
      std::optional<core_tests_golubetstest::AnEnum>>
  EchoNullableEnum(const core_tests_golubetstest::AnEnum* an_enum) override;
  core_tests_golubetstest::ErrorOr<
      std::optional<core_tests_golubetstest::AnotherEnum>>
  EchoAnotherNullableEnum(
      const core_tests_golubetstest::AnotherEnum* another_enum) override;
  core_tests_golubetstest::ErrorOr<std::optional<int64_t>>
  ...
  void EchoAsyncAllTypes(
      const core_tests_golubetstest::AllTypes& everything,
      std::function<void(
          core_tests_golubetstest::ErrorOr<core_tests_golubetstest::AllTypes>
              reply)>
          result) override;
  ...
  void EchoAsyncNullableAllNullableTypes(
      const core_tests_golubetstest::AllNullableTypes* everything,
      std::function<void(core_tests_golubetstest::ErrorOr<std::optional<
                             core_tests_golubetstest::AllNullableTypes>>
                             reply)>
          result) override;
  ...
  void EchoAsyncNullableAllNullableTypesWithoutRecursion(
      const core_tests_golubetstest::AllNullableTypesWithoutRecursion*
          everything,
      std::function<
          void(core_tests_golubetstest::ErrorOr<std::optional<
                   core_tests_golubetstest::AllNullableTypesWithoutRecursion>>
                   reply)>
          result) override;
  void EchoAsyncInt(
      int64_t an_int,
      std::function<void(core_tests_golubetstest::ErrorOr<int64_t> reply)>
          result) override;
  void EchoAsyncDouble(
      double a_double,
      std::function<void(core_tests_golubetstest::ErrorOr<double> reply)>
          result) override;
  void EchoAsyncBool(
      bool a_bool,
      std::function<void(core_tests_golubetstest::ErrorOr<bool> reply)> result)
      override;
  ...
  void EchoAsyncUint8List(
      ...
      std::function<
          void(core_tests_golubetstest::ErrorOr<std::vector<uint8_t>> reply)>
          result) override;
  ...
  void EchoAsyncList(
      ...
      std::function<
          void(core_tests_golubetstest::ErrorOr<flutter::EncodableList> reply)>
          result) override;
  ...
  void EchoAsyncMap(
      ...
      std::function<
          void(core_tests_golubetstest::ErrorOr<flutter::EncodableMap> reply)>
          result) override;
  ...
  void EchoAsyncNullableInt(
      ...
      std::function<
          void(core_tests_golubetstest::ErrorOr<std::optional<int64_t>> reply)>
          result) override;
  void EchoAsyncNullableDouble(
      const double* a_double,
      std::function<
          void(core_tests_golubetstest::ErrorOr<std::optional<double>> reply)>
          result) override;
  void EchoAsyncNullableBool(
      const bool* a_bool,
      std::function<
          void(core_tests_golubetstest::ErrorOr<std::optional<bool>> reply)>
          result) override;
  void EchoAsyncNullableString(
      const std::string* a_string,
      std::function<void(
          core_tests_golubetstest::ErrorOr<std::optional<std::string>> reply)>
          result) override;
  ...
  void CallFlutterSendMultipleNullableTypesWithoutRecursion(
      ...
      const std::string* a_nullable_string,
      std::function<
          void(core_tests_golubetstest::ErrorOr<
               core_tests_golubetstest::AllNullableTypesWithoutRecursion>
                   reply)>
          result) override;
  ...
  void CallFlutterSmallApiEchoString(
      ...
      std::function<void(core_tests_golubetstest::ErrorOr<std::string> reply)>
          result) override;
  core_tests_golubetstest::UnusedClass TestUnusedClassGenerates();

 private:
  std::unique_ptr<core_tests_golubetstest::FlutterIntegrationCoreApi>
      flutter_api_;
  std::unique_ptr<core_tests_golubetstest::FlutterSmallApi>
