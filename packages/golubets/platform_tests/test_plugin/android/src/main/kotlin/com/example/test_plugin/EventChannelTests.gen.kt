...
data class EventAllNullableTypes(
  ...
  companion object {
    fun fromList(golubetsVar_list: List<Any?>): EventAllNullableTypes {
      ...
      val aNullableEnum = golubetsVar_list[8] as EventEnum?
      val anotherNullableEnum = golubetsVar_list[9] as AnotherEventEnum?
      val aNullableString = golubetsVar_list[10] as String?
      val aNullableObject = golubetsVar_list[11]
      val allNullableTypes = golubetsVar_list[12] as EventAllNullableTypes?
      ...
      val enumList = golubetsVar_list[18] as List<EventEnum?>?
      ...
      val recursiveClassList = golubetsVar_list[22] as List<EventAllNullableTypes?>?
      ...
      val enumMap = golubetsVar_list[26] as Map<EventEnum?, EventEnum?>?
      ...
      val recursiveClassMap = golubetsVar_list[30] as Map<Long?, EventAllNullableTypes?>?
...
data class IntEvent(val value: Long) : PlatformEvent() {
  companion object {
    fun fromList(golubetsVar_list: List<Any?>): IntEvent {
      val value = golubetsVar_list[0] as Long
...
data class StringEvent(val value: String) : PlatformEvent() {
  companion object {
    fun fromList(golubetsVar_list: List<Any?>): StringEvent {
      val value = golubetsVar_list[0] as String
...
data class BoolEvent(val value: Boolean) : PlatformEvent() {
  companion object {
    fun fromList(golubetsVar_list: List<Any?>): BoolEvent {
      val value = golubetsVar_list[0] as Boolean
...
data class DoubleEvent(val value: Double) : PlatformEvent() {
  companion object {
    fun fromList(golubetsVar_list: List<Any?>): DoubleEvent {
      val value = golubetsVar_list[0] as Double
...
data class ObjectsEvent(val value: Any) : PlatformEvent() {
  companion object {
    fun fromList(golubetsVar_list: List<Any?>): ObjectsEvent {
      val value = golubetsVar_list[0] as Any
...
data class EnumEvent(val value: EventEnum) : PlatformEvent() {
  companion object {
    fun fromList(golubetsVar_list: List<Any?>): EnumEvent {
      val value = golubetsVar_list[0] as EventEnum
...
data class ClassEvent(val value: EventAllNullableTypes) : PlatformEvent() {
  companion object {
    fun fromList(golubetsVar_list: List<Any?>): ClassEvent {
      val value = golubetsVar_list[0] as EventAllNullableTypes
...
val EventChannelTestsGolubetsMethodCodec = StandardMethodCodec(EventChannelTestsGolubetsCodec())

private class EventChannelTestsGolubetsStreamHandler<T>(
    val wrapper: EventChannelTestsGolubetsEventChannelWrapper<T>
...
interface EventChannelTestsGolubetsEventChannelWrapper<T> {
...
abstract class StreamIntsStreamHandler : EventChannelTestsGolubetsEventChannelWrapper<Long> {
  companion object {
    fun register(
      ...
      val internalStreamHandler = EventChannelTestsGolubetsStreamHandler<Long>(streamHandler)
      EventChannel(messenger, channelName, EventChannelTestsGolubetsMethodCodec)
...
abstract class StreamEventsStreamHandler :
    EventChannelTestsGolubetsEventChannelWrapper<PlatformEvent> {
  companion object {
    fun register(
        messenger: BinaryMessenger,
      ...
      val internalStreamHandler =
          EventChannelTestsGolubetsStreamHandler<PlatformEvent>(streamHandler)
      EventChannel(messenger, channelName, EventChannelTestsGolubetsMethodCodec)
          .setStreamHandler(internalStreamHandler)
    }
  }
...
abstract class StreamConsistentNumbersStreamHandler :
    EventChannelTestsGolubetsEventChannelWrapper<Long> {
  companion object {
    fun register(
        messenger: BinaryMessenger,
...
interface SealedClassApi {
  ...
  companion object {
    ...
    val codec: MessageCodec<Any?> by lazy { EventChannelTestsGolubetsCodec() }
      ...
      run {
        val channel =
            BasicMessageChannel<Any?>(
                binaryMessenger,
                "dev.bayori.golubets.golubets_integration_tests.SealedClassApi.echo$separatedMessageChannelSuffix",
                codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> =
                try {
                  ...
                  EventChannelTestsGolubetsUtils.wrapError(exception)
                }
            reply.reply(wrapped)
          }
        } else {
