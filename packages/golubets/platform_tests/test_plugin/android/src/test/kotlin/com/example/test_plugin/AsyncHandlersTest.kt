...
internal class AsyncHandlersTest {
  ...
  fun testAsyncHost2Flutter() {
    ...
    verify {
      binaryMessenger.send(
          "dev.bayori.golubets.golubets_integration_tests.FlutterIntegrationCoreApi.echoAsyncString",
          any(),
          any())
    }
  }
  ...
  fun testAsyncFlutter2HostEcho() {
    ...
    val input = "Test"
    val channelName = "dev.bayori.golubets.golubets_integration_tests.HostSmallApi.echo"

    every {
      binaryMessenger.setMessageHandler(
          "dev.bayori.golubets.golubets_integration_tests.HostSmallApi.voidVoid", any())
    } returns Unit
  ...
  fun testAsyncFlutter2HostVoidVoid() {
    ...
    val channelName = "dev.bayori.golubets.golubets_integration_tests.HostSmallApi.voidVoid"

    every { binaryMessenger.setMessageHandler(channelName, capture(handlerSlot)) } returns Unit
    every {
      binaryMessenger.setMessageHandler(
          "dev.bayori.golubets.golubets_integration_tests.HostSmallApi.echo", any())
    } returns Unit
