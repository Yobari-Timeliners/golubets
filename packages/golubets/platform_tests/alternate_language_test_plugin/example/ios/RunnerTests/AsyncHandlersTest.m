...
- (void)testAsyncFlutter2HostVoidVoid {
  ...
  NSString *channelName = @"dev.bayori.golubets.golubets_integration_tests.HostSmallApi.voidVoid";
...
- (void)testAsyncFlutter2Host {
  ...
  SetUpFLTHostSmallApi(binaryMessenger, mockHostSmallApi);
  NSString *channelName = @"dev.bayori.golubets.golubets_integration_tests.HostSmallApi.echo";
  XCTAssertNotNil(binaryMessenger.handlers[channelName]);
