...
+ (instancetype)makeWithAField:(nullable id)aField {
  FLTUnusedClass *golubetsResult = [[FLTUnusedClass alloc] init];
  golubetsResult.aField = aField;
  return golubetsResult;
}
+ (FLTUnusedClass *)fromList:(NSArray<id> *)list {
  FLTUnusedClass *golubetsResult = [[FLTUnusedClass alloc] init];
  golubetsResult.aField = GetNullableObjectAtIndex(list, 0);
  return golubetsResult;
}
+ (nullable FLTUnusedClass *)nullableFromList:(NSArray<id> *)list {
...
+ (instancetype)makeWithABool:(BOOL)aBool
  ...
  FLTAllTypes *golubetsResult = [[FLTAllTypes alloc] init];
  golubetsResult.aBool = aBool;
  golubetsResult.anInt = anInt;
  golubetsResult.anInt64 = anInt64;
  golubetsResult.aDouble = aDouble;
  golubetsResult.aByteArray = aByteArray;
  golubetsResult.a4ByteArray = a4ByteArray;
  golubetsResult.a8ByteArray = a8ByteArray;
  golubetsResult.aFloatArray = aFloatArray;
  golubetsResult.anEnum = anEnum;
  golubetsResult.anotherEnum = anotherEnum;
  golubetsResult.aString = aString;
  golubetsResult.anObject = anObject;
  golubetsResult.list = list;
  golubetsResult.stringList = stringList;
  golubetsResult.intList = intList;
  golubetsResult.doubleList = doubleList;
  golubetsResult.boolList = boolList;
  golubetsResult.enumList = enumList;
  golubetsResult.objectList = objectList;
  golubetsResult.listList = listList;
  golubetsResult.mapList = mapList;
  golubetsResult.map = map;
  golubetsResult.stringMap = stringMap;
  golubetsResult.intMap = intMap;
  golubetsResult.enumMap = enumMap;
  golubetsResult.objectMap = objectMap;
  golubetsResult.listMap = listMap;
  golubetsResult.mapMap = mapMap;
  return golubetsResult;
}
+ (FLTAllTypes *)fromList:(NSArray<id> *)list {
  FLTAllTypes *golubetsResult = [[FLTAllTypes alloc] init];
  golubetsResult.aBool = [GetNullableObjectAtIndex(list, 0) boolValue];
  golubetsResult.anInt = [GetNullableObjectAtIndex(list, 1) integerValue];
  golubetsResult.anInt64 = [GetNullableObjectAtIndex(list, 2) integerValue];
  golubetsResult.aDouble = [GetNullableObjectAtIndex(list, 3) doubleValue];
  golubetsResult.aByteArray = GetNullableObjectAtIndex(list, 4);
  golubetsResult.a4ByteArray = GetNullableObjectAtIndex(list, 5);
  golubetsResult.a8ByteArray = GetNullableObjectAtIndex(list, 6);
  golubetsResult.aFloatArray = GetNullableObjectAtIndex(list, 7);
  FLTAnEnumBox *boxedFLTAnEnum = GetNullableObjectAtIndex(list, 8);
  golubetsResult.anEnum = boxedFLTAnEnum.value;
  FLTAnotherEnumBox *boxedFLTAnotherEnum = GetNullableObjectAtIndex(list, 9);
  golubetsResult.anotherEnum = boxedFLTAnotherEnum.value;
  golubetsResult.aString = GetNullableObjectAtIndex(list, 10);
  golubetsResult.anObject = GetNullableObjectAtIndex(list, 11);
  golubetsResult.list = GetNullableObjectAtIndex(list, 12);
  golubetsResult.stringList = GetNullableObjectAtIndex(list, 13);
  golubetsResult.intList = GetNullableObjectAtIndex(list, 14);
  golubetsResult.doubleList = GetNullableObjectAtIndex(list, 15);
  golubetsResult.boolList = GetNullableObjectAtIndex(list, 16);
  golubetsResult.enumList = GetNullableObjectAtIndex(list, 17);
  golubetsResult.objectList = GetNullableObjectAtIndex(list, 18);
  golubetsResult.listList = GetNullableObjectAtIndex(list, 19);
  golubetsResult.mapList = GetNullableObjectAtIndex(list, 20);
  golubetsResult.map = GetNullableObjectAtIndex(list, 21);
  golubetsResult.stringMap = GetNullableObjectAtIndex(list, 22);
  golubetsResult.intMap = GetNullableObjectAtIndex(list, 23);
  golubetsResult.enumMap = GetNullableObjectAtIndex(list, 24);
  golubetsResult.objectMap = GetNullableObjectAtIndex(list, 25);
  golubetsResult.listMap = GetNullableObjectAtIndex(list, 26);
  golubetsResult.mapMap = GetNullableObjectAtIndex(list, 27);
  return golubetsResult;
}
+ (nullable FLTAllTypes *)nullableFromList:(NSArray<id> *)list {
...
+ (instancetype)
  ...
  FLTAllNullableTypes *golubetsResult = [[FLTAllNullableTypes alloc] init];
  golubetsResult.aNullableBool = aNullableBool;
  golubetsResult.aNullableInt = aNullableInt;
  golubetsResult.aNullableInt64 = aNullableInt64;
  golubetsResult.aNullableDouble = aNullableDouble;
  golubetsResult.aNullableByteArray = aNullableByteArray;
  golubetsResult.aNullable4ByteArray = aNullable4ByteArray;
  golubetsResult.aNullable8ByteArray = aNullable8ByteArray;
  golubetsResult.aNullableFloatArray = aNullableFloatArray;
  golubetsResult.aNullableEnum = aNullableEnum;
  golubetsResult.anotherNullableEnum = anotherNullableEnum;
  golubetsResult.aNullableString = aNullableString;
  golubetsResult.aNullableObject = aNullableObject;
  golubetsResult.allNullableTypes = allNullableTypes;
  golubetsResult.list = list;
  golubetsResult.stringList = stringList;
  golubetsResult.intList = intList;
  golubetsResult.doubleList = doubleList;
  ...
  golubetsResult.listList = listList;
  golubetsResult.mapList = mapList;
  golubetsResult.recursiveClassList = recursiveClassList;
  golubetsResult.map = map;
  golubetsResult.stringMap = stringMap;
  golubetsResult.intMap = intMap;
  golubetsResult.enumMap = enumMap;
  ...
  golubetsResult.listMap = listMap;
  golubetsResult.mapMap = mapMap;
  golubetsResult.recursiveClassMap = recursiveClassMap;
  return golubetsResult;
}
+ (FLTAllNullableTypes *)fromList:(NSArray<id> *)list {
  FLTAllNullableTypes *golubetsResult = [[FLTAllNullableTypes alloc] init];
  golubetsResult.aNullableBool = GetNullableObjectAtIndex(list, 0);
  golubetsResult.aNullableInt = GetNullableObjectAtIndex(list, 1);
  golubetsResult.aNullableInt64 = GetNullableObjectAtIndex(list, 2);
  golubetsResult.aNullableDouble = GetNullableObjectAtIndex(list, 3);
  golubetsResult.aNullableByteArray = GetNullableObjectAtIndex(list, 4);
  golubetsResult.aNullable4ByteArray = GetNullableObjectAtIndex(list, 5);
  golubetsResult.aNullable8ByteArray = GetNullableObjectAtIndex(list, 6);
  golubetsResult.aNullableFloatArray = GetNullableObjectAtIndex(list, 7);
  golubetsResult.aNullableEnum = GetNullableObjectAtIndex(list, 8);
  golubetsResult.anotherNullableEnum = GetNullableObjectAtIndex(list, 9);
  golubetsResult.aNullableString = GetNullableObjectAtIndex(list, 10);
  golubetsResult.aNullableObject = GetNullableObjectAtIndex(list, 11);
  golubetsResult.allNullableTypes = GetNullableObjectAtIndex(list, 12);
  golubetsResult.list = GetNullableObjectAtIndex(list, 13);
  golubetsResult.stringList = GetNullableObjectAtIndex(list, 14);
  golubetsResult.intList = GetNullableObjectAtIndex(list, 15);
  golubetsResult.doubleList = GetNullableObjectAtIndex(list, 16);
  golubetsResult.boolList = GetNullableObjectAtIndex(list, 17);
  golubetsResult.enumList = GetNullableObjectAtIndex(list, 18);
  golubetsResult.objectList = GetNullableObjectAtIndex(list, 19);
  golubetsResult.listList = GetNullableObjectAtIndex(list, 20);
  golubetsResult.mapList = GetNullableObjectAtIndex(list, 21);
  golubetsResult.recursiveClassList = GetNullableObjectAtIndex(list, 22);
  golubetsResult.map = GetNullableObjectAtIndex(list, 23);
  golubetsResult.stringMap = GetNullableObjectAtIndex(list, 24);
  golubetsResult.intMap = GetNullableObjectAtIndex(list, 25);
  golubetsResult.enumMap = GetNullableObjectAtIndex(list, 26);
  golubetsResult.objectMap = GetNullableObjectAtIndex(list, 27);
  golubetsResult.listMap = GetNullableObjectAtIndex(list, 28);
  golubetsResult.mapMap = GetNullableObjectAtIndex(list, 29);
  golubetsResult.recursiveClassMap = GetNullableObjectAtIndex(list, 30);
  return golubetsResult;
}
+ (nullable FLTAllNullableTypes *)nullableFromList:(NSArray<id> *)list {
          ...
          aNullableObject:(nullable id)aNullableObject
               ...
               objectList:(nullable NSArray<id> *)objectList
                ...
                objectMap:(nullable NSDictionary<id, id> *)objectMap
                  listMap:(nullable NSDictionary<NSNumber *, NSArray<id> *> *)listMap
                   mapMap:(nullable NSDictionary<NSNumber *, NSDictionary<id, id> *> *)mapMap {
  FLTAllNullableTypesWithoutRecursion *golubetsResult =
...
+ (FLTAnEmptyClass *)fromList:(NSArray<id> *)list {
  FLTAnEmptyClass *golubetsResult = [[FLTAnEmptyClass alloc] init];
  return golubetsResult;
}
+ (nullable FLTAnEmptyClass *)nullableFromList:(NSArray<id> *)list {
...
+ (instancetype)
  ...
  FLTAllClassesWrapper *golubetsResult = [[FLTAllClassesWrapper alloc] init];
  golubetsResult.allNullableTypes = allNullableTypes;
  golubetsResult.allNullableTypesWithoutRecursion = allNullableTypesWithoutRecursion;
  golubetsResult.allTypes = allTypes;
  golubetsResult.classList = classList;
  golubetsResult.nullableClassList = nullableClassList;
  golubetsResult.classMap = classMap;
  golubetsResult.nullableClassMap = nullableClassMap;
  golubetsResult.anEmptyClass = anEmptyClass;
  return golubetsResult;
}
+ (FLTAllClassesWrapper *)fromList:(NSArray<id> *)list {
  FLTAllClassesWrapper *golubetsResult = [[FLTAllClassesWrapper alloc] init];
  golubetsResult.allNullableTypes = GetNullableObjectAtIndex(list, 0);
  golubetsResult.allNullableTypesWithoutRecursion = GetNullableObjectAtIndex(list, 1);
  golubetsResult.allTypes = GetNullableObjectAtIndex(list, 2);
  golubetsResult.classList = GetNullableObjectAtIndex(list, 3);
  golubetsResult.nullableClassList = GetNullableObjectAtIndex(list, 4);
  golubetsResult.classMap = GetNullableObjectAtIndex(list, 5);
  golubetsResult.nullableClassMap = GetNullableObjectAtIndex(list, 6);
  golubetsResult.anEmptyClass = GetNullableObjectAtIndex(list, 7);
  return golubetsResult;
}
+ (nullable FLTAllClassesWrapper *)nullableFromList:(NSArray<id> *)list {
                  ...
                  anotherEnum:(FLTAnotherEnum)anotherEnum
                   ...
                   objectList:(NSArray<id> *)objectList
                    ...
                    objectMap:(NSDictionary<id, id> *)objectMap
                      listMap:(NSDictionary<NSNumber *, NSArray<id> *> *)listMap
                       mapMap:(NSDictionary<NSNumber *, NSDictionary<id, id> *> *)mapMap {
  FLTImmutableAllTypes *golubetsResult = [[FLTImmutableAllTypes alloc] init];
  golubetsResult.aBool = aBool;
  golubetsResult.anInt = anInt;
  golubetsResult.anInt64 = anInt64;
  golubetsResult.aDouble = aDouble;
...
+ (FLTImmutableAllTypes *)fromList:(NSArray<id> *)list {
  ...
  golubetsResult.anotherEnum = boxedFLTAnotherEnum.value;
  golubetsResult.aString = GetNullableObjectAtIndex(list, 6);
  golubetsResult.anObject = GetNullableObjectAtIndex(list, 7);
  golubetsResult.list = GetNullableObjectAtIndex(list, 8);
  golubetsResult.stringList = GetNullableObjectAtIndex(list, 9);
  golubetsResult.intList = GetNullableObjectAtIndex(list, 10);
  golubetsResult.doubleList = GetNullableObjectAtIndex(list, 11);
  golubetsResult.boolList = GetNullableObjectAtIndex(list, 12);
  golubetsResult.enumList = GetNullableObjectAtIndex(list, 13);
  golubetsResult.objectList = GetNullableObjectAtIndex(list, 14);
  golubetsResult.listList = GetNullableObjectAtIndex(list, 15);
  golubetsResult.mapList = GetNullableObjectAtIndex(list, 16);
  golubetsResult.map = GetNullableObjectAtIndex(list, 17);
  golubetsResult.stringMap = GetNullableObjectAtIndex(list, 18);
  golubetsResult.intMap = GetNullableObjectAtIndex(list, 19);
  golubetsResult.enumMap = GetNullableObjectAtIndex(list, 20);
  golubetsResult.objectMap = GetNullableObjectAtIndex(list, 21);
  golubetsResult.listMap = GetNullableObjectAtIndex(list, 22);
  golubetsResult.mapMap = GetNullableObjectAtIndex(list, 23);
  return golubetsResult;
}
+ (nullable FLTImmutableAllTypes *)nullableFromList:(NSArray<id> *)list {
...
- (BOOL)isEqual:(id)object {
  ...
  FLTImmutableAllTypes *other = (FLTImmutableAllTypes *)object;
  return self.aBool == other.aBool && self.anInt == other.anInt && self.anInt64 == other.anInt64 &&
         (self.aDouble == other.aDouble || (isnan(self.aDouble) && isnan(other.aDouble))) &&
         self.anEnum == other.anEnum && self.anotherEnum == other.anotherEnum &&
         FLTPigeonDeepEquals(self.aString, other.aString) &&
         FLTPigeonDeepEquals(self.anObject, other.anObject) &&
         FLTPigeonDeepEquals(self.list, other.list) &&
         FLTPigeonDeepEquals(self.stringList, other.stringList) &&
...
- (NSString *)description {
  return [NSString
      stringWithFormat:@"FLTImmutableAllTypes(aBool: %@, anInt: %ld, anInt64: %ld, aDouble: %f, "
                       @"anEnum: %ld, anotherEnum: %ld, aString: %@, anObject: %@, list: %@, "
                       @"stringList: %@, intList: %@, doubleList: %@, boolList: %@, enumList: %@, "
                       @"objectList: %@, listList: %@, mapList: %@, map: %@, stringMap: %@, "
                       @"intMap: %@, enumMap: %@, objectMap: %@, listMap: %@, mapMap: %@)",
                       self.aBool ? @"true" : @"false", (long)self.anInt, (long)self.anInt64,
                       self.aDouble, (long)self.anEnum, (long)self.anotherEnum, self.aString,
                       self.anObject, self.list, self.stringList, self.intList, self.doubleList,
                       self.boolList, self.enumList, self.objectList, self.listList, self.mapList,
                       self.map, self.stringMap, self.intMap, self.enumMap, self.objectMap,
                       self.listMap, self.mapMap];
}
@end
...
+ (instancetype)makeWithABool:(BOOL)aBool
  ...
  FLTAllTypesWithDefaults *golubetsResult = [[FLTAllTypesWithDefaults alloc] init];
  golubetsResult.aBool = aBool;
  golubetsResult.anInt = anInt;
  golubetsResult.anInt64 = anInt64;
  golubetsResult.aDouble = aDouble;
...
+ (FLTAllTypesWithDefaults *)fromList:(NSArray<id> *)list {
  ...
  golubetsResult.listMap = GetNullableObjectAtIndex(list, 22);
  golubetsResult.mapMap = GetNullableObjectAtIndex(list, 23);
  golubetsResult.allTypes = GetNullableObjectAtIndex(list, 24);
  return golubetsResult;
}
+ (nullable FLTAllTypesWithDefaults *)nullableFromList:(NSArray<id> *)list {
...
- (BOOL)isEqual:(id)object {
  ...
  FLTAllTypesWithDefaults *other = (FLTAllTypesWithDefaults *)object;
  return self.aBool == other.aBool && self.anInt == other.anInt && self.anInt64 == other.anInt64 &&
         (self.aDouble == other.aDouble || (isnan(self.aDouble) && isnan(other.aDouble))) &&
         self.anEnum == other.anEnum && self.anotherEnum == other.anotherEnum &&
         FLTPigeonDeepEquals(self.aString, other.aString) &&
...
- (NSString *)description {
  return [NSString
      stringWithFormat:
          @"FLTAllTypesWithDefaults(aBool: %@, anInt: %ld, anInt64: %ld, aDouble: %f, anEnum: %ld, "
          @"anotherEnum: %ld, aString: %@, anObject: %@, list: %@, stringList: %@, intList: %@, "
          @"doubleList: %@, boolList: %@, enumList: %@, objectList: %@, listList: %@, mapList: %@, "
          @"map: %@, stringMap: %@, intMap: %@, enumMap: %@, objectMap: %@, listMap: %@, mapMap: "
          @"%@, allTypes: %@)",
          self.aBool ? @"true" : @"false", (long)self.anInt, (long)self.anInt64, self.aDouble,
          (long)self.anEnum, (long)self.anotherEnum, self.aString, self.anObject, self.list,
          self.stringList, self.intList, self.doubleList, self.boolList, self.enumList,
          self.objectList, self.listList, self.mapList, self.map, self.stringMap, self.intMap,
          self.enumMap, self.objectMap, self.listMap, self.mapMap, self.allTypes];
}
@end

@implementation FLTTestMessage
+ (instancetype)makeWithTestList:(nullable NSArray<id> *)testList {
  FLTTestMessage *golubetsResult = [[FLTTestMessage alloc] init];
  golubetsResult.testList = testList;
  return golubetsResult;
}
+ (FLTTestMessage *)fromList:(NSArray<id> *)list {
  FLTTestMessage *golubetsResult = [[FLTTestMessage alloc] init];
  golubetsResult.testList = GetNullableObjectAtIndex(list, 0);
  return golubetsResult;
}
+ (nullable FLTTestMessage *)nullableFromList:(NSArray<id> *)list {
...
@interface FLTCoreTestsGolubetsCodecReader : FlutterStandardReader
@end
@implementation FLTCoreTestsGolubetsCodecReader
...
@interface FLTCoreTestsGolubetsCodecWriter : FlutterStandardWriter
@end
@implementation FLTCoreTestsGolubetsCodecWriter
...
@interface FLTCoreTestsGolubetsCodecReaderWriter : FlutterStandardReaderWriter
@end
@implementation FLTCoreTestsGolubetsCodecReaderWriter
- (FlutterStandardWriter *)writerWithData:(NSMutableData *)data {
  return [[FLTCoreTestsGolubetsCodecWriter alloc] initWithData:data];
}
- (FlutterStandardReader *)readerWithData:(NSData *)data {
  return [[FLTCoreTestsGolubetsCodecReader alloc] initWithData:data];
}
@end
...
NSObject<FlutterMessageCodec> *FLTGetCoreTestsCodec(void) {
  ...
  dispatch_once(&sPred, ^{
    FLTCoreTestsGolubetsCodecReaderWriter *readerWriter =
        [[FLTCoreTestsGolubetsCodecReaderWriter alloc] init];
...
void SetUpFLTHostIntegrationCoreApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger,
  ...
  /// test basic calling.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
  ...
  /// Returns the passed list, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoStringList",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed list, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoIntList",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed list, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoDoubleList",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed list, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoBoolList",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed list, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoEnumList",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed list, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoClassList",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed map, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoStringMap",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed map, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoIntMap",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed map, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoEnumMap",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed map, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoClassMap",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed class to test nested class serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoClassWrapper",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed enum to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoAnotherEnum",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns passed in int.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoRequiredInt",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns passed in int.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoNullableInt",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed in boolean.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoNullableBool",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed list, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoNullableList",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed map, to test serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoNullableMap",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoNullableEnum",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns passed in double asynchronously.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoAsyncDouble",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed string asynchronously.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoAsyncString",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed in generic Object asynchronously.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoAsyncObject",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed map, to test asynchronous serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoAsyncIntMap",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Returns the passed map, to test asynchronous serialization and deserialization.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.echoAsyncEnumMap",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  /// Responds with an error from an async function returning a value.
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.throwAsyncError",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_integration_"
                                                   @"tests.HostIntegrationCoreApi.callFlutterNoop",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FLTGetCoreTestsCodec()];
    if (api) {
...
- (void)sendMultipleNullableTypesWithoutRecursionABool:(nullable NSNumber *)arg_aNullableBool
  ...
  NSString *channelName = [NSString
      stringWithFormat:@"%@%@",
                       @"dev.bayori.golubets.golubets_integration_tests.FlutterIntegrationCoreApi."
...
- (void)echoAnotherEnum:(FLTAnotherEnum)arg_anotherEnum
  ...
  NSString *channelName =
      [NSString stringWithFormat:@"%@%@",
                                 @"dev.bayori.golubets.golubets_integration_tests."
                                 @"FlutterIntegrationCoreApi.echoAnotherEnum",
                                 _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel messageChannelWithName:channelName
                                         binaryMessenger:self.binaryMessenger
...
- (void)echoNullableBool:(nullable NSNumber *)arg_aBool
  ...
  NSString *channelName =
      [NSString stringWithFormat:@"%@%@",
                                 @"dev.bayori.golubets.golubets_integration_tests."
                                 @"FlutterIntegrationCoreApi.echoNullableBool",
                                 _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel messageChannelWithName:channelName
                                         binaryMessenger:self.binaryMessenger
...
- (void)echoNullableInt:(nullable NSNumber *)arg_anInt
  ...
  NSString *channelName =
      [NSString stringWithFormat:@"%@%@",
                                 @"dev.bayori.golubets.golubets_integration_tests."
                                 @"FlutterIntegrationCoreApi.echoNullableInt",
                                 _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel messageChannelWithName:channelName
                                         binaryMessenger:self.binaryMessenger
...
- (void)echoNullableMap:(nullable NSDictionary<id, id> *)arg_map
  ...
  NSString *channelName =
      [NSString stringWithFormat:@"%@%@",
                                 @"dev.bayori.golubets.golubets_integration_tests."
                                 @"FlutterIntegrationCoreApi.echoNullableMap",
                                 _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel messageChannelWithName:channelName
                                         binaryMessenger:self.binaryMessenger
...
- (void)echoNullableEnum:(nullable FLTAnEnumBox *)arg_anEnum
  ...
  NSString *channelName =
      [NSString stringWithFormat:@"%@%@",
                                 @"dev.bayori.golubets.golubets_integration_tests."
                                 @"FlutterIntegrationCoreApi.echoNullableEnum",
                                 _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel messageChannelWithName:channelName
                                         binaryMessenger:self.binaryMessenger
...
- (void)echoAsyncString:(NSString *)arg_aString
  ...
  NSString *channelName =
      [NSString stringWithFormat:@"%@%@",
                                 @"dev.bayori.golubets.golubets_integration_tests."
                                 @"FlutterIntegrationCoreApi.echoAsyncString",
                                 _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel messageChannelWithName:channelName
                                         binaryMessenger:self.binaryMessenger
