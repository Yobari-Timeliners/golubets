    ...
    static void setUp(
      ...
      BinaryMessenger.TaskQueue taskQueue = binaryMessenger.makeBackgroundTaskQueue();
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.bayori.golubets.golubets_example_package.ExampleHostApi.getHostLanguage"
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.bayori.golubets.golubets_example_package.ExampleHostApi.sendMessageModernAsync"
                    + messageChannelSuffix,
                getCodec(),
                taskQueue);
        if (api != null) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.bayori.golubets.golubets_example_package.ExampleHostApi.sendMessageModernAsyncThrows"
                    + messageChannelSuffix,
                getCodec(),
                taskQueue);
        if (api != null) {
