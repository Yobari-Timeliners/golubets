...
+ (instancetype)makeWithName:(nullable NSString *)name
  ...
  PGNMessageData *golubetsResult = [[PGNMessageData alloc] init];
  golubetsResult.name = name;
  golubetsResult.description = description;
  golubetsResult.code = code;
  golubetsResult.data = data;
  return golubetsResult;
}
+ (PGNMessageData *)fromList:(NSArray<id> *)list {
  PGNMessageData *golubetsResult = [[PGNMessageData alloc] init];
  golubetsResult.name = GetNullableObjectAtIndex(list, 0);
  golubetsResult.description = GetNullableObjectAtIndex(list, 1);
  PGNCodeBox *boxedPGNCode = GetNullableObjectAtIndex(list, 2);
  golubetsResult.code = boxedPGNCode.value;
  golubetsResult.data = GetNullableObjectAtIndex(list, 3);
  return golubetsResult;
}
+ (nullable PGNMessageData *)nullableFromList:(NSArray<id> *)list {
...
@interface PGNMessagesGolubetsCodecReader : FlutterStandardReader
@end
@implementation PGNMessagesGolubetsCodecReader
...
@interface PGNMessagesGolubetsCodecWriter : FlutterStandardWriter
@end
@implementation PGNMessagesGolubetsCodecWriter
...
@interface PGNMessagesGolubetsCodecReaderWriter : FlutterStandardReaderWriter
@end
@implementation PGNMessagesGolubetsCodecReaderWriter
- (FlutterStandardWriter *)writerWithData:(NSMutableData *)data {
  return [[PGNMessagesGolubetsCodecWriter alloc] initWithData:data];
}
- (FlutterStandardReader *)readerWithData:(NSData *)data {
  return [[PGNMessagesGolubetsCodecReader alloc] initWithData:data];
}
@end
...
NSObject<FlutterMessageCodec> *PGNGetMessagesCodec(void) {
  ...
  dispatch_once(&sPred, ^{
    PGNMessagesGolubetsCodecReaderWriter *readerWriter =
        [[PGNMessagesGolubetsCodecReaderWriter alloc] init];
...
#endif
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.bayori.golubets.golubets_example_package."
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:
                                @"%@%@",
                                @"dev.bayori.golubets.golubets_example_package.ExampleHostApi.add",
                                messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:PGNGetMessagesCodec()];
    if (api) {
...
- (void)flutterMethodAString:(nullable NSString *)arg_aString
  ...
  NSString *channelName = [NSString
      stringWithFormat:
          @"%@%@", @"dev.bayori.golubets.golubets_example_package.MessageFlutterApi.flutterMethod",
