...
void main() {
  ...
  test('gen one enum class', () {
    ...
    expect(code, contains('golubetsResult.setEnum1((Enum1) enum1);'));
  });
  ...
  test('background platform channel', () {
    ...
    expect(
      ...
      contains(
        RegExp(
          r'new BasicMessageChannel<>\(\s*binaryMessenger, "dev.bayori.golubets.test_package.Api.doit" \+ messageChannelSuffix, getCodec\(\), taskQueue\)',
        ),
      ),
    );
  });
