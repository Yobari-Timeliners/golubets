...
void main() {
  group('ProxyApi', () {
    test('one api', () {
      ...
      // Instance Manager
      expect(code, contains(r'class MyFileGolubetsInstanceManager'));
      expect(code, contains(r'class MyFileGolubetsInstanceManagerApi'));

      // API registrar
      expect(
        code,
        contains(
          'abstract class MyFileGolubetsProxyApiRegistrar(val binaryMessenger: BinaryMessenger)',
        ),
      );
      ...
      expect(
        code,
        contains(
          'private class MyFileGolubetsProxyApiBaseCodec(val registrar: MyFileGolubetsProxyApiRegistrar) : MyFileGolubetsCodec()',
        ),
      );
      ...
      expect(
        code,
        contains(
          r'abstract class GolubetsApiApi(open val golubetsRegistrar: MyFileGolubetsProxyApiRegistrar)',
        ),
      );
      ...
      expect(
        collapsedCode,
        contains(
          r'fun golubets_newInstance(golubets_instanceArg: my.library.Api, callback: (Result<Unit>) -> Unit)',
        ),
      );
      ...
      expect(
        code,
        contains(
          'fun doSomethingElse(golubets_instanceArg: my.library.Api, inputArg: Input, callback: (Result<String>) -> Unit)',
        ),
      );
    });
    ...
    group('Constructors', () {
      test('empty name and no params constructor', () {
        ...
        expect(
          collapsedCode,
          contains(
            r'val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.bayori.golubets.test_package.Api.golubets_defaultConstructor"',
          ),
        );
        expect(
          collapsedCode,
          contains(
            r'api.golubetsRegistrar.instanceManager.addDartCreatedInstance(api.golubets_defaultConstructor(',
          ),
        );
      });
      ...
      test('multiple params constructor', () {
        ...
        expect(
          collapsedCode,
          contains(
            r'api.golubetsRegistrar.instanceManager.addDartCreatedInstance(api.name('
            r'validTypeArg,enumTypeArg,proxyApiTypeArg,nullableValidTypeArg,'
            r'nullableEnumTypeArg,nullableProxyApiTypeArg), golubets_identifierArg)',
          ),
        );
      });
      ...
      test('host platform constructor callback method', () {
        ...
        expect(
          collapsedCode,
          contains(
            'if (golubetsRegistrar.instanceManager.containsInstance(golubets_instanceArg)) { callback(Result.success(Unit))',
          ),
        );
      });
    ...
    group('Fields', () {
      test('constructor with fields', () {
        ...
        expect(
          collapsedCode,
          contains(
            'channel.send(listOf(golubets_identifierArg, validTypeArg, '
      ...
      test('attached field', () {
        ...
        expect(
          code,
          contains(
            r'api.golubetsRegistrar.instanceManager.addDartCreatedInstance(api.aField(golubets_instanceArg), golubets_identifierArg)',
          ),
        );
      });
      ...
      test('static attached field', () {
        ...
        expect(
          code,
          contains(
            r'api.golubetsRegistrar.instanceManager.addDartCreatedInstance(api.aField(), golubets_identifierArg)',
          ),
        );
      });
    });
    ...
    group('Host methods', () {
      test('multiple params method', () {
        ...
        expect(
          collapsedCode,
          contains(
            'abstract fun doSomething(golubets_instance: Api, validType: Long, '
        ...
        expect(
          collapsedCode,
          contains(
            r'api.doSomething(golubets_instanceArg, validTypeArg, enumTypeArg, '
    ...
    group('Flutter methods', () {
      test('multiple params flutter method', () {
        ...
        expect(
          collapsedCode,
          contains(
            'fun doSomething(golubets_instanceArg: Api, validTypeArg: Long, '
        ...
        expect(
          collapsedCode,
          contains(
            r'channel.send(listOf(golubets_instanceArg, validTypeArg, enumTypeArg, '
            r'proxyApiTypeArg, nullableValidTypeArg, nullableEnumTypeArg, '
            r'nullableProxyApiTypeArg))',
          ),
        );
