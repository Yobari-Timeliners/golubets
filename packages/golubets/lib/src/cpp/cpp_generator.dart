...
const String _codecSerializerName = 'GolubetsCodecSerializer';
...
class CppHeaderGenerator extends StructuredGenerator<InternalCppOptions> {
  ...
  void writeFileImports(
    ...
    indent.newln();
    indent.writeln('$_commentPrefix Generated class from Golubets.');
  }
  ...
  void writeDataClass(
    ...
    // When generating for a Golubets unit test, add a test fixture friend class to
...
EncodableValue $_overflowClassName::FromEncodableList(
  ...
  void writeFlutterApi(
    ...
    indent.writeln(
      '$_commentPrefix Generated class from Golubets that represents Flutter messages that can be called from C++.',
    );
    _writeFunctionDefinition(
      indent,
      api.name,
