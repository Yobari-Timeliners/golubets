...
class InternalGolubetsOptions {
  /// Creates a instance of InternalGolubetsOptions
  const InternalGolubetsOptions({
    required this.input,
  ...
  InternalGolubetsOptions._fromGolubetsOptionsWithHeader(
...
/// based on the contents of [InternalGolubetsOptions].
...
class RootBuilder extends dart_ast_visitor.RecursiveAstVisitor<Object?> {
  ...
  Object? visitImportDirective(dart_ast.ImportDirective node) {
    if (node.uri.stringValue != 'package:golubets/golubets.dart') {
      _errors.add(
        Error(
          message:
              "Unsupported import ${node.uri}, only imports of 'package:golubets/golubets.dart' are supported.",
