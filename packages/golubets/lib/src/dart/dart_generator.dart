...
const String golubetsChannelCodec = 'golubetsChannelCodec';

/// Documentation comment spec.
const DocumentCommentSpecification docCommentSpec =
    DocumentCommentSpecification(_docCommentPrefix);

/// The custom codec used for all golubets APIs.
const String _golubetsMessageCodec = '_GolubetsCodec';

/// Name of field used for host API codec.
const String _golubetsMethodChannelCodec = 'golubetsMethodCodec';

const String _overflowClassName = '_GolubetsCodecOverflow';
...
=======
            ...
            ? 'required '
            : '';
        final String defaultValueString = field.defaultValue == null
            ? ''
            : ' = ${field.defaultValue}';
...
>>>>>>> filtered-upstream/main:packages/pigeon/lib/src/dart/dart_generator.dart
    ...
    indent.newln();
    indent.write('class $_golubetsMessageCodec extends StandardMessageCodec');
    indent.addScoped(' {', '}', () {
      indent.writeln('const $_golubetsMessageCodec();');
      indent.writeln('@override');
    ...
    if (root.containsEventChannel) {
      indent.newln();
      indent.writeln(
        'const StandardMethodCodec $_golubetsMethodChannelCodec = StandardMethodCodec($_golubetsMessageCodec());',
      );
    }
  }
  ...
  void writeFlutterApi(
    ...
    indent.addScoped('{', '}', () {
      ...
      indent.writeln(
        'static const MessageCodec<Object?> $golubetsChannelCodec = $_golubetsMessageCodec();',
      );
      indent.newln();
    ...
    for (final Method func in api.methods) {
      ...
      Stream<${func.returnType.baseName}> ${func.name}(${_getMethodParameterSignature(func.parameters, addTrailingComma: true)} {String instanceName = ''}) {
        ...
        final EventChannel ${func.name}Channel =
            EventChannel('${makeChannelName(api, func, dartPackageName)}\$instanceName', $_golubetsMethodChannelCodec);
          ...
          builder
            ...
            ..fields.addAll(<cb.Field>[
              ...
              cb.Field((cb.FieldBuilder builder) {
                builder
                  ..name = golubetsChannelCodec
                  ..type = cb.refer('MessageCodec<Object?>')
                  ..static = true
                  ..modifier = cb.FieldModifier.constant
                  ..assignment = const cb.Code('$_golubetsMessageCodec()');
              }),
            ])
            ..methods.add(
...
''');
  ...
  static void writeHostMethodMessageCall(
    ...
    final String nullHandler = returnType.isNullable
...
=======
    final String defaultValue = p.defaultValue == null
        ? ''
        : ' = ${p.defaultValue}';
...
>>>>>>> filtered-upstream/main:packages/pigeon/lib/src/dart/dart_generator.dart
  ...
  final String baseParams = signature.isNotEmpty
